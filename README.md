...
Two executables are shipped: *SimulationCraft* sports a simple graphical user interface whereas *simc* uses a command-line interface. The GUI is largely unmaintained and users should aim for the command-line interface first.
