<?php
/**
 * Builds the configuration form for the simcraft simulation 
 */
class XML_SimcraftConfigForm extends SimpleXMLElement_XSL
{
	/**
	 * This gets around the weird 'feature' of SimpleXMLElement that 
	 * prevents you from extending the constructor.
	 * @return SXML_SimcraftConfigForm
	 */
	static public function factory()
	{
		// Create the output XML object
		$xml = new XML_SimcraftConfigForm('<xml></xml>');
	...
	public function append_simulation_config_form_elements( )
	{
		...
		SimpleXMLElement_XSL::simplexml_append($this, new XML_SimcraftConfigForm($str_options_xml));
	 ...
	 * .simcraft-style file at the given path
