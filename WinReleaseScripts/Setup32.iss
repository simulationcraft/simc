...
#define MyAppVersion "620-03"
#define RealAppVersion "6.2.0.03"
...
[Files]
Source: "C:\simulationcraft\simc-{#MyAppVersion}-win32\SimulationCraft.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\simulationcraft\simc-{#MyAppVersion}-win32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
