...
bool rogue_t::save( FILE* file )
{
  player_t::save( file );

  if( honor_among_thieves_interval != 0 )
  {
    fprintf( file, "# When using this profile with a real raid AND party setups, override this value to zero.\n" );
    fprintf( file, "# This does not include HAT procs generated by the Rogue himself.\n" );
    fprintf( file, "honor_among_thieves_interval=%.2f\n", honor_among_thieves_interval );
  }
