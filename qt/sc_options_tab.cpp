...
const OptionEntry scalingOptions[] =
{
  ...
  { "Analyze Readiness Rating",         "read",     "Calculate scale factors for Readiness Rating"         },
...
const OptionEntry plotOptions[] =
{
  ...
  { "Plot Scaling per Readiness Rating", "read",    "Generate Scaling curve for Readiness Rating" },
...
const OptionEntry reforgePlotOptions[] =
{
  ...
  { "Plot Reforge Options for Readiness Rating", "read",    "Generate reforge plot data for Readiness Rating" },
