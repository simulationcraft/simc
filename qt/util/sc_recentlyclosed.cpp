...
SC_TabWidgetCloseAll::SC_TabWidgetCloseAll( QWidget* parent, Qt::Corner corner, QString closeAllWarningTitle,
...
{
  int confirm = QMessageBox::warning( this, closeAllTabsTitleText, closeAllTabsBodyText,
...
{
  int confirm = QMessageBox::warning( this, closeOtherTabsTitleText, closeOtherTabsBodyText,
                                      QMessageBox::Yes | QMessageBox::No, QMessageBox::No );
  if ( confirm == QMessageBox::Yes )
    closeOtherTabs();
}
...
SC_RecentlyClosedTabItemModel::SC_RecentlyClosedTabItemModel( QObject* parent ) : QStandardItemModel( parent )
{
...
void SC_RecentlyClosedTabItemModel::addTab( QWidget* widget, const QString& title, const QString& tooltip,
                                            const QIcon& icon )
{
...
SC_RecentlyClosedTabWidget::SC_RecentlyClosedTabWidget( QWidget* parent, QBoxLayout::Direction grow,
...
void SC_RecentlyClosedTabWidget::init()
{
  ...
  connect( model, SIGNAL( restoreTab( QWidget*, const QString&, const QString&, const QIcon& ) ), this,
           SIGNAL( restoreTab( QWidget*, const QString&, const QString&, const QIcon& ) ) );
}
...
QWidget* SC_RecentlyClosedTabWidget::initListView()
{
  ...
  connect( listView->selectionModel(), SIGNAL( currentChanged( const QModelIndex&, const QModelIndex& ) ), this,
...
bool SC_RecentlyClosedTabWidget::previewNext( QWidget* exclude )
{
  ...
  while ( triedRows <= model->rowCount() && widget == exclude )
  {
  ...
  if ( index.isValid() && triedRows <= model->rowCount() )
  {
    QItemSelectionModel* selection = listView->selectionModel();
...
SC_RecentlyClosedTab::SC_RecentlyClosedTab( QWidget* parent, SC_RecentlyClosedTabItemModel* modelToUse,
                                            bool enableRecentlyClosedTabs, Qt::Corner corner )
    ...
    recentlyClosedTab( nullptr )
{
  if ( enabled )
  {
    ...
    connect( recentlyClosedTab, SIGNAL( restoreTab( QWidget*, const QString&, const QString&, const QIcon& ) ), this,
             SLOT( restoreTab( QWidget*, const QString&, const QString&, const QIcon& ) ) );
...
void SC_RecentlyClosedTab::restoreTab( QWidget* widget, const QString& title, const QString& tooltip,
                                       const QIcon& icon )
{
