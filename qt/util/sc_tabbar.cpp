...
SC_TabBar::SC_TabBar( QWidget* parent, bool enableDraggedHover, bool enableMouseHover, bool enableContextMenu )
  : QTabBar( parent ),
    hoveringOverTab( -1 ),
...
{
  bool ok;
  QString text = QInputDialog::getText( this, tr( "Modify Tab Title" ), tr( "New Tab Title:" ), QLineEdit::Normal,
