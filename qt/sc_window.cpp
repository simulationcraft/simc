...
void SimcraftWindow::createWelcomeTab()
{
  const char* s =
    ...
    "It is a multi-player event driven simulator written in C++ that models raid damage. "
    "Increasing class synergy and the prevalence of proc-based combat modifiers have "
    ...
    "<dd>"
    "At its core, SimulationCraft is a parameter-driven batch simulation tool.  This interface is a "
    ...
    "<dd>"
    "In general the flow is from left to right across the main tabs at the top of the window.  "
    ...
    "At <i>Results</i> you will find HTML output generated by the simulator. "
    "</dd>"
    "</dl>";
