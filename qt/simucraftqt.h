...
#ifndef SIMUCRAFTQT_H
#define SIMUCRAFTQT_H
...
class SimucraftWebView;
class SimucraftCommandLine;
...
class SimucraftWindow : public QWidget
{
    Q_OBJECT
...
public:
    ...
    SimucraftWebView* armoryUsView;
    SimucraftWebView* armoryEuView;
    SimucraftWebView* wowheadView;
    SimucraftWebView* chardevView;
    SimucraftWebView* warcrafterView;
    SimucraftWebView* visibleWebView;
...
public:
    SimucraftWindow(QWidget *parent = 0);
};

class SimucraftCommandLine : public QLineEdit
{
  SimucraftWindow* mainWindow;
...
public:
  SimucraftCommandLine( SimucraftWindow* mw ) : mainWindow(mw) {}
};

class SimucraftWebView : public QWebView
{
  Q_OBJECT
...
public:
  SimucraftWebView( SimucraftWindow* mw ) : 
...
public:
    ...
    virtual void run();
    SimulateThread( SimucraftWindow* mw ) : mainWindow(mw), sim(0) {}
};
...
public:
    ...
    virtual void run();
    ImportThread( SimucraftWindow* mw ) : mainWindow(mw), sim(0), player(0) {}
};
