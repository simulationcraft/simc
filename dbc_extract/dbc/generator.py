...
class SpellDataGenerator(DataGenerator):
    ...
    _item_set_list = [
        (),
        # Tier13,                Tier14,                      Tier15
        ( ( 1073, 1074, ),       ( 1144, 1145, ),             ( 1172, 1173 ), ),             # Warrior
        ( ( 1063, 1065, 1064, ), ( 1134, 1135, 1136, ),       ( 1162, 1163, 1164 ) ),        # Paladin
        ( ( 1061, ),             ( 1129, ),                   ( 1157, ) ),                   # Hunter
        ( ( 1068, ),             ( 1139, ),                   ( 1167, ) ),                   # Rogue
        ( ( 1066, 1067, ),       ( 1137, 1138, ),             ( 1165, 1166 ), ),             # Priest
        ( ( 1056, 1057, ),       ( 1123, 1124, ),             ( 1151, 1152 ) ),              # Death Knight
        ( ( 1070, 1071, 1069, ), ( 1140, 1141, 1142, ),       ( 1168, 1169, 1170 ), ),       # Shaman
        ( ( 1062, ),             ( 1130, ),                   ( 1158, ), ),                  # Mage
        ( ( 1072, ),             ( 1143, ),                   ( 1171, ), ),                  # Warlock
        ( ( ),                   ( 1131, 1132, 1133, ),       ( 1159, 1160, 1161 ) ),        # Monk
        ( ( 1059, 1058, 1060 ),  ( 1125, 1126, 1127, 1128, ), ( 1153, 1154, 1155, 1156 ), ), # Druid
    ]
