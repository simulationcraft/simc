...
./dbc_extract.py -p $INPUT --itemcache=$CACHEDIR -b $BUILD$PTR -t spell> $OUTPATH/sc_spell_data${PTR:+_ptr}.inc
...
./dbc_extract.py -p $INPUT --itemcache=$CACHEDIR -b $BUILD$PTR -t item > $OUTPATH/sc_item_data${PTR:+_ptr}.inc
