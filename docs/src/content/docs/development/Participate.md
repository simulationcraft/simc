...
Checkout the [Developers Corner wiki page](Participate.md) for more detailed information on how to setup your 
...
Please check out our [CodingGuidelines](CodingGuidelines.md) before you start.
