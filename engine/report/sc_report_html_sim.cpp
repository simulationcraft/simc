...
void print_html_raid_imagemap( report::sc_html_stream& os, const sim_t& sim, size_t num, int dps )
{
...
void print_html_raid_imagemaps( report::sc_html_stream& os, const sim_t& sim, sim_report_information_t& ri )
{
