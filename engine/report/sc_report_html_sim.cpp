...
void print_html_styles( report::sc_html_stream& os, sim_t* sim )
{
  ...
  else if ( sim -> print_styles == 2 )
  {
    os << "\t\t<style type=\"text/css\" media=\"all\">\n"
       ...
       << "\t\t\t.player h2 {margin: 0; }\n"
       << "\t\t\t.player ul.params {position: relative;top: 2px; }\n"
       << "\t\t\t#masthead {height: auto;padding-bottom: 30px;border: 0;-moz-border-radius: 15px;-khtml-border-radius: 15px;-webkit-border-radius: 15px;border-radius: 15px;-moz-box-shadow: 0px 0px 8px #FDD017;-webkit-box-shadow: 0px 0px 8px #FDD017;box-shadow: 0px 0px 8px #FDD017;text-align: left;color: #FDD017;background: #000 " << simc_logo() << " 7px 13px no-repeat; }\n"
  ...
  else
  {
    ...
    os << ") -440px -10px; }\n"
       << "\t\t\t#logo {display: block;position: absolute;top: 7px;left: 15px;width: 375px;height: 153px;background: " << simc_logo() << " 0px 0px no-repeat; }\n"
