...
struct report_utility {



static void print_html_rng_information( FILE* file, rng_t* rng );
...
static std::string raid_downtime ( const std::vector<player_t*> &players_by_name, bool print_styles );
