...
void print_html_action_damage( report::html_stream& os, stats_t* s, player_t* p, int j )
{
  int id = 0;
...
int print_html_action_resource( report::html_stream& os, stats_t* s, int j )
{
  for ( size_t i = 0; i < s -> player -> action_list.size(); ++i )
  {
    action_t* a = s -> player -> action_list[ i ];
...
void print_html_gear ( report::html_stream& os, player_t* p )
{
  os.print(
...
void print_html_profile ( report::html_stream& os, player_t* a )
{
...
void print_html_stats ( report::html_stream& os, player_t* a )
{
  std::string n = a -> name();
...
void print_html_talents( report::html_stream& os, player_t* p )
{
  std::string n = p -> name();
  util::format_text( n, true );
...
void print_html_player_scale_factors( report::html_stream& os, sim_t* sim, player_t* p, player_t::report_information_t& ri )
{
  ...
  if ( !p -> is_pet() )
  {
    if ( p -> sim -> scaling -> has_scale_factors() )
    {
      ...
      for ( size_t i = 0; i < p -> scaling_stats.size(); i++ )
      {
        ...
        os.print( "%s", util::stat_type_abbrev( p -> scaling_stats[ i ] ) );
      }
      os << "\t\t\t\t\t\t\t\t\t</ul>\n"
         << "\t\t\t\t\t\t\t\t</td>\n"
         << "\t\t\t\t\t\t\t</tr>\n";
...
void print_html_player_action_priority_list( report::html_stream& os, sim_t* sim, player_t* p )
{
...
void print_html_player_statistics( report::html_stream& os, player_t* p, player_t::report_information_t& ri )
{
...
void print_html_gain( report::html_stream& os, gain_t* g, int& j, bool report_overflow = true )
{
  for ( resource_e i = RESOURCE_NONE; i < RESOURCE_MAX; i++ )
  {
...
void print_html_player_resources( report::html_stream& os, player_t* p, player_t::report_information_t& ri )
{
  os.set_level( 4 );
...
void print_html_player_charts( report::html_stream& os, sim_t* sim, player_t* p, player_t::report_information_t& ri )
{
  ...
  if ( ! ri.action_dpet_chart.empty() )
  {
    ...
    os.print( fmt, ri.action_dpet_chart.c_str() );
  }
  ...
  if ( ! ri.action_dmg_chart.empty() )
  {
    ...
    os.print( fmt, ri.action_dmg_chart.c_str() );
  }
  ...
  if ( ! ri.scaling_dps_chart.empty() )
  {
    ...
    os.print( fmt, ri.scaling_dps_chart.c_str() );
  }
  ...
  if ( ! ri.reforge_dps_chart.empty() )
  {
    ...
    os.print( fmt, ri.reforge_dps_chart.c_str() );
  }
  ...
  if ( ! ri.scale_factors_chart.empty() )
  {
    ...
    os.print( fmt, ri.scale_factors_chart.c_str() );
  }
  ...
  if ( ! ri.timeline_dps_chart.empty() )
  {
    ...
    os.print( fmt, ri.timeline_dps_chart.c_str() );
  }
  ...
  if ( ! ri.distribution_dps_chart.empty() )
  {
    ...
    os.print( fmt, ri.distribution_dps_chart.c_str() );
  }
  ...
  if ( ! ri.time_spent_chart.empty() )
  {
    ...
    os.print( fmt, ri.time_spent_chart.c_str() );
  }
...
void print_html_player_buff( report::html_stream& os, buff_t* b, int report_details, size_t i, bool constant_buffs = false )
{
...
void print_html_player_buffs( report::html_stream& os, player_t* p, player_t::report_information_t& ri )
{
  // Buff Section
...
void print_html_player_description( report::html_stream& os, sim_t* sim, player_t* p, int j, std::string& n )
{
  ...
  if ( p -> dps.mean >= p -> hps.mean )
    os.print("\">%s&nbsp;:&nbsp;%.0f dps</h2>\n",
             n.c_str(),
             p -> dps.mean );
  else
    os.print( "\">%s&nbsp;:&nbsp;%.0f hps</h2>\n",
             n.c_str(),
             p -> hps.mean );
...
void print_html_player_results_spec_gear( report::html_stream& os, sim_t* sim, player_t* p )
{
...
void print_html_player_abilities( report::html_stream& os, sim_t* sim, player_t* p, std::string& name )
{
...
void print_html_player_benefits_uptimes( report::html_stream& os, player_t* p )
{
...
void print_html_player_procs( report::html_stream& os, std::vector<proc_t*> pr )
{
  // Procs Section
...
void print_html_player_deaths( report::html_stream& os, player_t* p, player_t::report_information_t& ri )
{
  // Death Analysis
...
void print_html_player_gear_weights( report::html_stream& os, player_t* p, player_t::report_information_t& ri )
{
...
void print_html_player_( report::html_stream& os, sim_t* sim, player_t* q, int j=0 )
{
...
void print_html_player( report::html_stream& os, player_t* p, int j=0 )
{
