...
enum full_result_e
{
  ...
  FULLTYPE_HIT_BLOCK,
  FULLTYPE_HIT,
  FULLTYPE_MULTISTRIKE_CRITBLOCK,
  FULLTYPE_MULTISTRIKE_BLOCK,
  FULLTYPE_MULTISTRIKE,
  FULLTYPE_MULTISTRIKE_CRIT_CRITBLOCK,
  FULLTYPE_MULTISTRIKE_CRIT_BLOCK,
  FULLTYPE_MULTISTRIKE_CRIT,
  FULLTYPE_MAX
};
