...
enum food_e
{
  ...
  // legion
  FOOD_AZSHARI_SALAD,
  FOOD_BARRACUDDA_MRGLGAGH,
  // FOOD_BEAR_TARTARE,
  FOOD_DROGBARSTYLE_SALMON,
  // FOOD_FIGHTER_CHOW,
  FOOD_FISHBRUL_SPECIAL,
  FOOD_HEARTY_FEAST,
  FOOD_KOISCENTED_STORMRAY,
  FOOD_LAVISH_SURAMAR_FEAST,
  FOOD_LEYBEQUE_RIBS,
  FOOD_NIGHTBORNE_DELICACY_PLATTER,
  FOOD_SEEDBATTERED_FISH_PLATE,
  FOOD_SURAMAR_SURF_AND_TURF,
  FOOD_THE_HUNGRY_MAGISTER,
