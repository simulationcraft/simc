...
int set_bonus_t::tier15_2pc_caster() const { return ( count[ SET_T15_2PC_CASTER ] > 0 || ( count[ SET_T15_2PC_CASTER ] < 0 && count[ SET_T15_CASTER ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier15_4pc_caster() const { return ( count[ SET_T15_4PC_CASTER ] > 0 || ( count[ SET_T15_4PC_CASTER ] < 0 && count[ SET_T15_CASTER ] >= 4 ) ) ? 1 : 0; }

int set_bonus_t::tier15_2pc_melee() const { return ( count[ SET_T15_2PC_MELEE ] > 0 || ( count[ SET_T15_2PC_MELEE ] < 0 && count[ SET_T15_MELEE ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier15_4pc_melee() const { return ( count[ SET_T15_4PC_MELEE ] > 0 || ( count[ SET_T15_4PC_MELEE ] < 0 && count[ SET_T15_MELEE ] >= 4 ) ) ? 1 : 0; }

int set_bonus_t::tier15_2pc_tank() const { return ( count[ SET_T15_2PC_TANK ] > 0 || ( count[ SET_T15_2PC_TANK ] < 0 && count[ SET_T15_TANK ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier15_4pc_tank() const { return ( count[ SET_T15_4PC_TANK ] > 0 || ( count[ SET_T15_4PC_TANK ] < 0 && count[ SET_T15_TANK ] >= 4 ) ) ? 1 : 0; }

int set_bonus_t::tier15_2pc_heal() const { return ( count[ SET_T15_2PC_HEAL ] > 0 || ( count[ SET_T15_2PC_HEAL ] < 0 && count[ SET_T15_HEAL ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier15_4pc_heal() const { return ( count[ SET_T15_4PC_HEAL ] > 0 || ( count[ SET_T15_4PC_HEAL ] < 0 && count[ SET_T15_HEAL ] >= 4 ) ) ? 1 : 0; }

// set_bonus_t::tier16 ======================================================

int set_bonus_t::tier16_2pc_caster() const { return ( count[ SET_T16_2PC_CASTER ] > 0 || ( count[ SET_T16_2PC_CASTER ] < 0 && count[ SET_T16_CASTER ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier16_4pc_caster() const { return ( count[ SET_T16_4PC_CASTER ] > 0 || ( count[ SET_T16_4PC_CASTER ] < 0 && count[ SET_T16_CASTER ] >= 4 ) ) ? 1 : 0; }

int set_bonus_t::tier16_2pc_melee() const { return ( count[ SET_T16_2PC_MELEE ] > 0 || ( count[ SET_T16_2PC_MELEE ] < 0 && count[ SET_T16_MELEE ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier16_4pc_melee() const { return ( count[ SET_T16_4PC_MELEE ] > 0 || ( count[ SET_T16_4PC_MELEE ] < 0 && count[ SET_T16_MELEE ] >= 4 ) ) ? 1 : 0; }

int set_bonus_t::tier16_2pc_tank() const { return ( count[ SET_T16_2PC_TANK ] > 0 || ( count[ SET_T16_2PC_TANK ] < 0 && count[ SET_T16_TANK ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier16_4pc_tank() const { return ( count[ SET_T16_4PC_TANK ] > 0 || ( count[ SET_T16_4PC_TANK ] < 0 && count[ SET_T16_TANK ] >= 4 ) ) ? 1 : 0; }

int set_bonus_t::tier16_2pc_heal() const { return ( count[ SET_T16_2PC_HEAL ] > 0 || ( count[ SET_T16_2PC_HEAL ] < 0 && count[ SET_T16_HEAL ] >= 2 ) ) ? 1 : 0; }

int set_bonus_t::tier16_4pc_heal() const { return ( count[ SET_T16_4PC_HEAL ] > 0 || ( count[ SET_T16_4PC_HEAL ] < 0 && count[ SET_T16_HEAL ] >= 4 ) ) ? 1 : 0; }
