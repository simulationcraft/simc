...
enum assisted_combat_rule_e : unsigned
{
  SPELL_LEARNED                    = 0,
  SPELL_ON_COOLDOWN                = 1,
  SPELL_OFF_COOLDOWN               = 2,
  TARGET_DISTANCE_LESS             = 3,
  TARGET_DISTANCE_GREATER          = 4,
  HOSTILE_TARGET                   = 5,
  FRIENDLY_TARGET                  = 6,
  HEALTH_PCT_GREATER               = 7,
  HEALTH_PCT_LESS                  = 8,
  AURA_ON_PLAYER                   = 9,
  AURA_ON_TARGET                   = 10,
  TARGET_COUNT_NEAR_TARGET_GREATER = 11,
  TARGET_COUNT_NEAR_PLAYER_GREATER = 12,
  AURA_COUNT_NEAR_PLAYER_GREATER   = 13,
  AFFORD_COST                      = 14,
  AURA_MISSING_TARGET              = 15,
  AURA_MISSING_PLAYER              = 16,
  AURA_DURATION_PLAYER             = 17,
  AURA_DURATION_TARGET             = 18,
  MANA_GREATER                     = 19,
  MANA_LESS                        = 20,
  RAGE_GREATER                     = 21,
  RAGE_LESS                        = 22,
  ...
  ENERGY_GREATER                   = 25,
  ENERGY_LESS                      = 26,
  COMBO_POINTS_GREATER             = 27,
  COMBO_POINTS_LESS                = 28,
  RUNES_GREATER                    = 29,
  RUNES_LESS                       = 30,
  RUNIC_POWER_GREATER              = 31,
  RUNIC_POWER_LESS                 = 32,
  SOUL_SHARDS_GREATER              = 33,
  SOUL_SHARDS_LESS                 = 34,
  LUNAR_POWER_GREATER              = 35,
  LUNAR_POWER_LESS                 = 36,
  HOLY_POWER_GREATER               = 37,
  HOLY_POWER_LESS                  = 38,
  MAELSTROM_GREATER                = 39,
  MAELSTROM_LESS                   = 40,
  CHI_GREATER                      = 41,
  CHI_LESS                         = 42,
  INSANITY_GREATER                 = 43,
  ...
  ESSENCE_GREATER                  = 45,
  ESSENCE_LESS                     = 46,
  ARCANE_CHARGES_GREATER           = 47,
  ARCANE_CHARGES_LESS              = 48,
  TARGET_COUNT_NEAR_TARGET_LESS    = 49,
  TARGET_COUNT_NEAR_PLAYER_LESS    = 50,
  AURA_COUNT_NEAR_PLAYER_LESS      = 51,
  TARGET_AURA_APPLICATION_GREATER  = 52,
  TARGET_AURA_APPLICATION_LESS     = 53,
  PLAYER_AURA_APPLICATION_GREATER  = 54,
  PLAYER_AURA_APPLICATION_LESS     = 55,
  SPELL_IN_RANGE                   = 56,
  HAS_PET                          = 57,
  HAS_NO_PET                       = 58,
  FURY_GREATER                     = 59,
  ...
  PAIN_GREATER                     = 61,
  PAIN_LESS                        = 62,
  SPELL_CHARGES_GREATER            = 63,
  SPELL_CHARGES_LESS               = 64,
