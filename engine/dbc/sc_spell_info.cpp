...
static constexpr auto _targeting_strings = util::make_static_map<unsigned, std::string_view>( {
  ...
  { 15,  "Enemy in Area"                         },
  { 16,  "at Enemy in Area"                      },
  { 17,  "at Database Entry in Area"             },
  { 18,  "at Self"                               },
  { 20,  "Party in Area"                         },
  { 21,  "Targeted Ally"                         },
  { 22,  "Source"                                },
  { 23,  "Targeted Gameobject"                   },
  { 24,  "Enemies in Cone"                       },
  { 25,  "Current Target"                        },
  { 26,  "Targeted Item Gameobject"              },
  { 27,  "Master"                                },
  { 28,  "at Dynamic Enemy in Area"              },
  { 29,  "at Dynamic Ally in Area"               },
  { 30,  "Ally in Area"                          },
  { 31,  "At Ally in Area"                       },
  { 32,  "Summoner in Area"                      },
  { 33,  "Party in Area"                         },
  { 34,  "at Party in Area"                      },
  { 35,  "Targeted Party Member"                 },
  { 37,  "Last Targeted Party Member"            },
  { 38,  "Nearby Target"                         },
  { 39,  "at Fishing Target"                     },
  { 40,  "Nearby Gameobject"                     },
  { 41,  "Front Right of Self"                   },
  { 42,  "Back Right of Self"                    },
  { 43,  "Back Left of Self"                     },
  { 44,  "Front Left of Self"                    },
  { 45,  "Chain Heal Ally"                       },
  { 46,  "at Nearby"                             },
  { 47,  "Front of Self"                         },
  { 48,  "Back of Self"                          },
  { 49,  "Right of Self"                         },
  { 50,  "Left of Self"                          },
  { 51,  "Gameobject in Area"                    },
  { 52,  "at Gameobject in Area"                 },
  { 53,  "At Enemy"                              },
  { 54,  "Enemies in Cone (180 degree)"          },
  { 55,  "at Front of Leap Target"               },
  { 56,  "Raid in Area"                          },
  { 57,  "Targeted Raid Member"                  },
  { 58,  "Raid Nearby"                           },
  { 59,  "Allies in Cone"                        },
  { 60,  "Any in Cone"                           },
  { 61,  "Raid Class in Area"                    },
  { 62,  "at Ground"                             },
  { 63,  "at Target"                             },
  { 64,  "at Target Front"                       },
  { 65,  "at Target Back"                        },
  { 66,  "at Target Right"                       },
  { 67,  "at Target Left"                        },
  { 68,  "at Target Front Right"                 },
  { 69,  "at Target Back Right"                  },
  { 70,  "at Target Back Left"                   },
  { 71,  "at Target Front Left"                  },
  { 72,  "at Random"                             },
  { 73,  "at Radius"                             },
  { 74,  "at Target Random"                      },
  { 75,  "at Target Radius"                      },
  ...
  { 80,  "Right in Area"                         },
  { 81,  "Left in Area"                          },
  { 82,  "Front Right in Area"                   },
  { 83,  "Back Right in Area"                    },
  ...
  { 91,  "at Radius in Area"                     },
  { 92,  "Summoner"                              },
  { 93,  "Enemy Corpse in Area"                  },
  { 94,  "Vehicle"                               },
  { 95,  "Passenger"                             },
  { 96,  "Passenger 0"                           },
  { 97,  "Passenger 1"                           },
  ...
  { 102, "Passenger 6"                           },
  { 103, "Passenger 7"                           },
  { 104, "Enemies in Cone to Targeted Enemy"     },
  { 105, "Self and Passengers"                   },
  { 106, "Nearby in Database"                    },
  { 107, "At Nearby"                             },
  { 108, "Gameobject in Cone to Targeted Enemy"  },
  { 109, "Gameobject in Cone to Targeted Ally"   },
  { 110, "Cone from Self"                        },
  { 115, "Furthest Enemy in Area"                },
  { 116, "Last Targeted Enemy"                   },
  { 118, "Targeted Ally or Raid"                 },
  { 119, "Raid Corpse in Area"                   },
  { 120, "Self and Summons in Area"              },
  { 121, "Targeted Ally Corpse"                  },
  { 122, "Threat List in Area"                   },
  { 123, "Tap List in Area"                      },
  { 124, "Targeted Tap List"                     },
  { 125, "at Ground"                             },
  { 126, "Enemy Clump in Area"                   },
  { 127, "at Center of Enemy Clump in Area"      },
  { 128, "Target Reticule: Ally"                 },
  { 129, "Target Reticule: Enemy"                },
  { 130, "Target Reticule"                       },
  { 131, "at Summoner"                           },
  { 132, "at Targeted Ally"                      },
  { 133, "Line to Ally"                          },
  { 134, "Line to Enemy"                         },
  { 135, "Line from Self"                        },
  { 136, "Cone to Ally"                          },
  { 137, "in Area of Movement Direction"         },
  { 138, "in Area of Ground Area"                },
  { 140, "at Center of Ally Clump in Area"       },
  { 142, "Nearby: in Database or Entry"          },
  { 148, "in Area From Target to Self"           },
  { 150, "Own Critter"                           },
} );
