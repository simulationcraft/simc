...
struct druid_t : public player_t
{
  ...
  /* Changes, build 12984
  Balance
  NYI Wild Mushroom now becomes visible after 6 sec, up from 4 sec. Base damage increased by 400% (from 269-304 to 1300-1573 damage)
  NYI Wild Mushroom: Detonate no longer costs mana, now has a 10 sec cooldown, and affects target within 10 yards, down from 15 yards.
    X Starsurge now generates 15 Solar or Lunar Energy, up from 10.
    X Euphoria first effect revamped - While not in an Eclipse state, you have a 12/24% chance to double the Solar or Lunar energy generated by your Wrath or Starfire when they deal damage. When you reach a Solar or Lunar eclipse, you instantly are restored 6/12% of your total mana.
    X Earth and Moon now increases spell damage taken by 8%, down from 13%.
    X Lunar Guidance is gone.
    * Genesis no longer increases the damage done by your periodic spells and increases the duration of your Moonfire and Insect Swarm by 6 sec instead.
    X Nature's Grace revamped - You gain 5/10/15% spell haste after you cast Moonfire or Insect Swarm, lasting 15 sec. This effect has 1 minute cooldown. When you gain Lunar or Solar Eclipse, the cooldown of Nature's Torment is instantly reset.
    X Dreamstate (Tier 5) *New* - When you cast your Innervate on yourself, you regain an additional 10/30% of your total mana over its duration.
    X Sunfire (Tier 5) *New* - While in Solar Eclipse, your Moonfire spell will morph into Sunfire - Burns the enemy for 196.24 to 239.85 Nature damage and then an additional [ 374.92 * ( Genesis : 100%/102%/104%/106% ) ] Nature damage over 12 sec.
    X Shooting Stars (Tier 3) *New* - You have a 2/4% chance when you deal damage with your Moonfire or Insect Swarm to instantly reset the cooldown of your Starsurge and reduce its cast time by 100%. Lasts 8 sec.
