...
void sim_t::create_options()
{
  ...
  add_option( opt_bool("shadowlands.jotungeirr_swapto_zovastrum", shadowlands_opts.jotungeirr_swapto_zovastrum ) );
  add_option( opt_uint("shadowlands.jotungeirr_swapto_ilevel", shadowlands_opts.jotungeirr_swapto_ilevel, 311, 311 ) );  
}
