...
void rogue_t::init_action_list()
{
  ...
  else if ( specialization() == ROGUE_SUBTLETY )
  {
    ...
    def -> add_action( "call_action_list,name=stealth_als,if=talent.enveloping_shadows.enabled&(combo_points.deficit>=3|cooldown.shadow_dance.charges_fractional>=2.9)" );
