...
void paladin_t::generate_action_prio_list_ret()
{
  ...
  priority -> add_action( this, "Divine Storm", "if=debuff.judgment.up&(spell_targets.divine_storm>=2|buff.scarlet_inquisitors_expurgation.stack>=20&((buff.avenging_wrath.up|buff.crusade.up&buff.crusade.stack>=15)|(cooldown.crusade.remains>15&!buff.crusade.up|cooldown.avenging_wrath.remains>15)))&buff.divine_purpose.up&buff.divine_purpose.remains<gcd*2" );
  ...
  priority -> add_action( this, "Templar's Verdict", "if=debuff.judgment.up&cooldown.wake_of_ashes.remains<gcd*2&artifact.wake_of_ashes.enabled&(!talent.crusade.enabled|cooldown.crusade.remains>gcd*4)" );
  ...
  priority -> add_talent( this, "Consecration", "if=(cooldown.blade_of_justice.remains>gcd*2|cooldown.divine_hammer.remains>gcd*2)&(talent.the_fires_of_justice.enabled&cooldown.crusader_strike.charges_fractional<=1.4|!talent.the_fires_of_justice.enabled&charges_fractional<=1.65)" );
  ...
  priority -> add_action( this, "Divine Storm", "if=debuff.judgment.up&(spell_targets.divine_storm>=2|buff.scarlet_inquisitors_expurgation.stack>=20&((buff.avenging_wrath.up|buff.crusade.up&buff.crusade.stack>=15)|(cooldown.crusade.remains>15&!buff.crusade.up|cooldown.avenging_wrath.remains>15)))&buff.divine_purpose.react" );
