...
void paladin_t::generate_action_prio_list_ret()
{
  ...
  // Precombat casts
  precombat -> add_talent( this, "Retribution Aura" );
  ...
  precombat -> add_talent( this, "Shield of Vengeance" );
  ...
  cds -> add_talent( this, "Shield of Vengeance", "if=(!talent.execution_sentence|cooldown.execution_sentence.remains<52)&fight_remains>15" );
  ...
  cds -> add_talent( this, "Avenging Wrath", "if=(holy_power>=4&time<5|holy_power>=3&(time>5|runeforge.the_magistrates_judgment)|holy_power>=2&runeforge.vanguards_momentum&talent.final_reckoning|talent.holy_avenger&cooldown.holy_avenger.remains=0)&(!talent.seraphim|!talent.final_reckoning|cooldown.seraphim.remains>0)" );
  cds -> add_talent( this, "Crusade", "if=holy_power=5&time<5|holy_power>=3&time>5" );
  ...
  cds -> add_talent( this, "Final Reckoning", "if=(holy_power>=4&time<8|holy_power>=3&(time>=8|spell_targets.divine_storm>=2&covenant.kyrian))&(cooldown.avenging_wrath.remains>gcd|cooldown.crusade.remains&(!buff.crusade.up|buff.crusade.stack>=10))&(time_to_hpg>0|holy_power=5)&(!talent.seraphim|buff.seraphim.up)&(!raid_event.adds.exists|raid_event.adds.up|raid_event.adds.in>40)&(!buff.avenging_wrath.up|holy_power=5|cooldown.hammer_of_wrath.remains|spell_targets.divine_storm>=2&covenant.kyrian)" );
  ...
  es_fr_active -> add_talent( this, "Wake of Ashes", "if=holy_power<=2&(debuff.final_reckoning.up&debuff.final_reckoning.remains<gcd*2&!runeforge.divine_resonance|debuff.execution_sentence.up&debuff.execution_sentence.remains<gcd|spell_targets.divine_storm>=5&runeforge.divine_resonance&talent.execution_sentence)" );
  es_fr_active -> add_talent( this, "Blade of Justice", "if=conduit.expurgation&(!runeforge.divine_resonance&holy_power<=3|holy_power<=2)" );
  ...
  es_fr_active -> add_talent( this, "Wake of Ashes", "if=holy_power<=2" );
  es_fr_active -> add_talent( this, "Blade of Justice", "if=holy_power<=3" );
  es_fr_active -> add_action( this, "Judgment", "if=!debuff.judgment.up" );
  es_fr_active -> add_talent( this, "Hammer of Wrath" );
  es_fr_active -> add_action( this, "Crusader Strike" );
  es_fr_active -> add_action( "arcane_torrent" );
  es_fr_active -> add_talent( this, "Exorcism" );
  ...
  es_fr_pooling -> add_talent( this, "Hammer of Wrath", "if=runeforge.vanguards_momentum" );
  es_fr_pooling -> add_talent( this, "Wake of Ashes", "if=holy_power<=2&talent.ashes_to_dust&(cooldown.crusade.remains|cooldown.avenging_wrath.remains)" );
  es_fr_pooling -> add_talent( this, "Blade of Justice", "if=holy_power<=3" );
  es_fr_pooling -> add_action( this, "Judgment", "if=!debuff.judgment.up" );
  es_fr_pooling -> add_talent( this, "Hammer of Wrath" );
  ...
  es_fr_pooling -> add_talent( this, "Exorcism" );
  ...
  finishers -> add_action( "variable,name=ds_castable,value=spell_targets.divine_storm>=2|buff.empyrean_power.up&!debuff.judgment.up&!buff.divine_purpose.up" );
  ...
  finishers -> add_talent( this, "Execution Sentence", "if=(buff.crusade.down&cooldown.crusade.remains>10|buff.crusade.stack>=3|cooldown.avenging_wrath.remains>10)&(!talent.final_reckoning|cooldown.final_reckoning.remains>10)&target.time_to_die>8&(spell_targets.divine_storm<5|talent.executioners_wrath)" );
  finishers -> add_talent( this, "Radiant Decree", "if=(buff.crusade.down&cooldown.crusade.remains>5|buff.crusade.stack>=3|cooldown.avenging_wrath.remains>5)&(!talent.final_reckoning|cooldown.final_reckoning.remains>5)" );
  finishers -> add_talent( this, "Divine Storm", "if=variable.ds_castable&!buff.vanquishers_hammer.up&((!talent.crusade|cooldown.crusade.remains>gcd*3)&(!talent.execution_sentence|cooldown.execution_sentence.remains>gcd*6|cooldown.execution_sentence.remains>gcd*4&holy_power>=4|target.time_to_die<8|spell_targets.divine_storm>=5|!talent.seraphim&cooldown.execution_sentence.remains>gcd*2)&(!talent.final_reckoning|cooldown.final_reckoning.remains>gcd*6|cooldown.final_reckoning.remains>gcd*4&holy_power>=4|!talent.seraphim&cooldown.final_reckoning.remains>gcd*2)|talent.holy_avenger&cooldown.holy_avenger.remains<gcd*3|buff.holy_avenger.up|buff.crusade.up&buff.crusade.stack<10)" );
  ...
  generators -> add_talent( this, "Hammer of Wrath", "if=runeforge.the_mad_paragon|covenant.venthyr&cooldown.ashen_hallow.remains>210" );
  generators -> add_talent( this, "Wake of Ashes", "if=holy_power<=2&talent.ashes_to_dust&(cooldown.avenging_wrath.remains|cooldown.crusade.remains)" );
  ...
  generators -> add_talent( this, "Exorcism" );
  generators -> add_talent( this, "Blade of Justice", "if=conduit.expurgation&holy_power<=3" );
  generators -> add_action( this, "Judgment", "if=!debuff.judgment.up" );
  generators -> add_talent( this, "Hammer of Wrath" );
  generators -> add_talent( this, "Blade of Justice", "if=holy_power<=3" );
