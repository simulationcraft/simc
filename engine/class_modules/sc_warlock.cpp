...
struct chaos_bolt_t: public warlock_spell_t
{
  ...
  {
    multistrike_direct( source_state, ms_state );
...
void warlock_t::apl_affliction()
{
  ...
  add_action( "Soulburn", "if=shard_react&talent.soulburn_haunt.enabled&buff.soulburn.down&(buff.haunting_spirits.remains-action.haunt.cast_time<=buff.haunting_spirits.duration*0.3)" );
  add_action( "Haunt", "if=shard_react&talent.soulburn_haunt.enabled&!in_flight_to_target&((buff.soulburn.up&((buff.haunting_spirits.remains-cast_time<=buff.haunting_spirits.duration*0.3&dot.haunt.remains-cast_time<=dot.haunt.duration*0.3)|buff.haunting_spirits.down)))" );
  ...
  add_action( "Unstable Affliction", "cycle_targets=1,if=target.time_to_die>10&remains-cast_time<=(duration*0.3)" );
...
void warlock_t::apl_destruction()
{
  ...
  single_target -> action_list_str += "/fire_and_brimstone,if=buff.fire_and_brimstone.down&dot.immolate.remains-action.immolate.cast_time<=(dot.immolate.duration*0.3)&active_enemies>4";
