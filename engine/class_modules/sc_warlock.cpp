...
void warlock_t::apl_destruction()
{
  ...
  add_action( "Dimensional Rift", "if=equipped.144369&!buff.lessons_of_spacetime.remains&((!talent.grimoire_of_supremacy.enabled&(!cooldown.summon_doomguard.remains|pet.doomguard.active|pet.infernal.active))|(talent.grimoire_of_service.enabled&(!cooldown.service_pet.remains|pet.service_imp.active))|(talent.soul_harvest.enabled&(!cooldown.soul_harvest.remains|buff.soul_harvest.remains)))");
  action_list_str += "/service_pet";
