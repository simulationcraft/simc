...
void hunter_t::apl_surv()
{
  ...
  precombat -> add_action( "explosive_trap,if" );
  ...
  moknathal -> add_action( "a_murder_of_crows,if=focus>60&-buff.moknathal_tactics.remains*focus.regen&buff.mongoose_fury.stack<4&buff.mongoose_fury.duration>=gcd" );
  moknathal -> add_action( "flanking_strike,if=focus>80-buff.moknathal_tactics.remains*focus.regen&(cooldown.mongoose_bite.charges<=1&buff.aspect_of_the_eagle.remains>=gcd|cooldown.mongoose_bite.charges<=1&buff.aspect_of_the_eagle.down)" );
  moknathal -> add_action( "lacerate,if=(focus>65-buff.moknathal_tactics.remains*focus.regen&buff.mongoose_fury.duration>=gcd&refreshable&cooldown.mongoose_bite.charges=0&buff.mongoose_fury.stack<3)|(focus>65-buff.moknathal_tactics.remains*focus.regen&buff.mongoose_fury.down&cooldown.mongoose_bite.charges<3&refreshable)" );
  ...
  moknathal -> add_action( "butchery,if=active_enemies>1&focus>70-buff.moknathal_tactics.remains*focus.regen&(buff.mongoose_fury.down|buff.mongoose_fury.remains>gcd*cooldown.mongoose_bite.charges)" );
  moknathal -> add_action( "carve,if=active_enemies>1&(buff.mongoose_fury.down&focus>70-buff.moknathal_tactics.remains*focus.regen|buff.mongoose_fury.remains>gcd*cooldown.mongoose_bite.charges&focus>70-buff.moknathal_tactics.remains*focus.regen)" );
  ...
  moknathal -> add_action( "flanking_strike,if=cooldown.mongoose_bite.charges<=2&buff.mongoose_fury.remains>(1+action.mongoose_bite.charges*gcd)&focus>80-buff.moknathal_tactics.remains*focus.regen" );
  ...
  moknathal -> add_action( "a_murder_of_crows,if=focus>60-buff.moknathal_tactics.remains*focus.regen" );
  ...
  moknathal -> add_action( "butchery,if=(charges=3&focus>70-buff.moknathal_tactics.remains*focus.regen)" );
  moknathal -> add_action( "mongoose_bite,if=(charges>=2&cooldown.mongoose_bite.remains<=gcd|charges=3)" );
  moknathal -> add_action( "butchery,if=focus>70-buff.moknathal_tactics.remains*focus.regen" );
