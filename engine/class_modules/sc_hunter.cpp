...
void hunter_t::apl_bm()
{
  ...
  default_list -> add_action( "use_item,name=galecallers_boon,if=buff.aspect_of_the_wild.remains>10|cooldown.aspect_of_the_wild.remains>45|target.time_to_die<11" );
