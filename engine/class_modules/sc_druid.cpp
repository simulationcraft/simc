...
void druid_t::apl_guardian()
{
  ...
  bear->add_action( "moonfire,if=(refreshable&active_enemies<2&target.time_to_die>12)|(refreshable&!dot.moonfire.ticking&active_enemies>1&target.time_to_die>12)" );
