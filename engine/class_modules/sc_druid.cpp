...
void druid_t::apl_balance()
{
  ...
  boat->add_action( "starsurge,if=!variable.critnotup&(cooldown.ca_inc.remains>7|covenant.night_fae)&(cooldown.empower_bond.remains>7|!covenant.kyrian)|buff.kindred_empowerment_energize.up&cooldown.ca_inc.remains>30&eclipse.in_any" );
