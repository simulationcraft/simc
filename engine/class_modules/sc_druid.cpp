  ...
  if ( action_list_str.empty() )
  {
    ...
    if ( specialization() == DRUID_FERAL && primary_role() == ROLE_ATTACK )
    {
      ...
      if ( level >= 90 )
      {
        ...
        action_list_str += "/healing_touch,if=talent.dream_of_cenarius.enabled&buff.predatory_swiftness.up&combo_points>=4&buff.dream_of_cenarius_damage.stack<2";
        action_list_str += "/healing_touch,if=talent.dream_of_cenarius.enabled&buff.predatory_swiftness.up&buff.predatory_swiftness.remains<=1&buff.dream_of_cenarius_damage.down";
        action_list_str += "/healing_touch,if=talent.dream_of_cenarius.enabled&prev.natures_swiftness";
        ...
        action_list_str += "/natures_swiftness,if=talent.dream_of_cenarius.enabled&buff.dream_of_cenarius_damage.down&buff.predatory_swiftness.down&combo_points>=5&target.health.pct<=25";
        ...
        action_list_str += "/natures_swiftness,if=talent.dream_of_cenarius.enabled&buff.dream_of_cenarius_damage.down&buff.predatory_swiftness.down&combo_points>=5&dot.rip.remains<3&(buff.berserk.up|dot.rip.remains<=cooldown.tigers_fury.remains)&target.health.pct>25";
    ...
    else if ( specialization() == DRUID_BALANCE && ( primary_role() == ROLE_SPELL || primary_role() == ROLE_DPS ) )
    {
      ...
      action_list_str += "/moonfire,cycle_targets=1,if=(remains<(buff.natures_grace.remains-2+2*set_bonus.tier14_4pc_caster))";
      action_list_str += "/sunfire,cycle_targets=1,if=(remains<(buff.natures_grace.remains-2+2*set_bonus.tier14_4pc_caster))";
