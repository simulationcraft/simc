...
void survival( player_t* p )
{
  ...
  cds -> add_action( "steel_trap,if=runeforge.nessingwarys_trapping_apparatus.equipped&!talent.birds_of_prey.enabled&focus<action.mongoose_bite.cost" );
  cds -> add_action( "freezing_trap,if=runeforge.nessingwarys_trapping_apparatus.equipped&!talent.birds_of_prey.enabled&focus<action.mongoose_bite.cost&!buff.wild_spirits.remains|runeforge.nessingwarys_trapping_apparatus.equipped&buff.wild_spirits.remains&cooldown.kill_command.remains&focus<action.mongoose_bite.cost" );
  cds -> add_action( "tar_trap,if=runeforge.nessingwarys_trapping_apparatus.equipped&!talent.birds_of_prey.enabled&focus<action.mongoose_bite.cost&!buff.wild_spirits.remains|runeforge.nessingwarys_trapping_apparatus.equipped&buff.wild_spirits.remains&cooldown.kill_command.remains&focus<action.mongoose_bite.cost|focus+cast_regen<focus.max&runeforge.soulforge_embers.equipped&tar_trap.remains<gcd&cooldown.flare.remains<gcd&(active_enemies>1|active_enemies=1&time_to_die>5*gcd)" );
  ...
  bop -> add_action( "steel_trap,if=runeforge.nessingwarys_trapping_apparatus.equipped&focus<action.mongoose_bite.cost" );
  bop -> add_action( "freezing_trap,if=runeforge.nessingwarys_trapping_apparatus.equipped&focus<action.mongoose_bite.cost&!buff.wild_spirits.remains|runeforge.nessingwarys_trapping_apparatus.equipped&buff.wild_spirits.remains&cooldown.kill_command.remains&focus<action.mongoose_bite.cost" );
  bop -> add_action( "tar_trap,if=runeforge.nessingwarys_trapping_apparatus.equipped&focus<action.mongoose_bite.cost&!buff.wild_spirits.remains|runeforge.nessingwarys_trapping_apparatus.equipped&buff.wild_spirits.remains&cooldown.kill_command.remains&focus<action.mongoose_bite.cost" );
  bop -> add_action( "raptor_strike,target_if=max:debuff.latent_poison_injection.stack,if=buff.coordinated_assault.up&buff.coordinated_assault.remains<2*gcd" );
  bop -> add_action( "mongoose_bite,target_if=max:debuff.latent_poison_injection.stack,if=buff.coordinated_assault.up&buff.coordinated_assault.remains<2*gcd" );
