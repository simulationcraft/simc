...
void affliction( player_t* p )
{
  ...
  default_->add_action( "summon_darkglare,if=debuff.shadow_embrace.stack=3&variable.ps_up&variable.vt_up&variable.sr_up|cooldown.invoke_power_infusion_0.duration>0&cooldown.invoke_power_infusion_0.up&!talent.soul_rot" );
