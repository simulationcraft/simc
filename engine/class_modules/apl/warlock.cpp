...
namespace warlock_apl{
  ...
  {
    if ( p->true_level >= 80 ) return "flask_of_tempered_swiftness_3";
...
void affliction( player_t* p )
{
  ...
  precombat->add_action( "variable,name=trinket_1_buffs,value=trinket.1.has_use_buff" "Used to set Trinkets as Buff Trinkets for the automatic logic" );
  precombat->add_action( "variable,name=trinket_2_buffs,value=trinket.2.has_use_buff" "Used to set Trinkets as Buff Trinkets for the automatic logic" );
