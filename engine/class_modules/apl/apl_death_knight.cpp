...
void frost( player_t* p )
{
  ...
  cooldowns->add_action( "abomination_limb,if=variable.st_planning&(talent.pillar_of_frost&cooldown.pillar_of_frost.remains<gcd*2|!talent.pillar_of_frost)&(talent.breath_of_sindragosa&runic_power>65&cooldown.breath_of_sindragosa.remains<2|!talent.breath_of_sindragosa)" );
  cooldowns->add_action( "abomination_limb,if=variable.adds_remain" );
