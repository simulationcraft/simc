...
void blood( player_t* p )
{
  ...
  precombat->add_action( "variable,name=trinket_1_buffs,value=trinket.1.has_use_buff.strength|trinket.1.has_use_buff.mastery|trinket.1.has_use_buff.versatility|trinket.1.has_use_buff.haste|trinket.1.has_use_buff.crit" );
  precombat->add_action( "variable,name=trinket_2_buffs,value=trinket.2.has_use_buff.strength|trinket.2.has_use_buff.mastery|trinket.2.has_use_buff.versatility|trinket.2.has_use_buff.haste|trinket.2.has_use_buff.crit" );
...
void unholy( player_t* p )
{
  ...
  precombat->add_action( "variable,name=trinket_1_buffs,value=trinket.1.has_use_buff|(trinket.1.has_use_buff.strength|trinket.1.has_use_buff.mastery|trinket.1.has_use_buff.versatility|trinket.1.has_use_buff.haste|trinket.1.has_use_buff.crit)" );
  precombat->add_action( "variable,name=trinket_2_buffs,value=trinket.2.has_use_buff|(trinket.2.has_use_buff.strength|trinket.2.has_use_buff.mastery|trinket.2.has_use_buff.versatility|trinket.2.has_use_buff.haste|trinket.2.has_use_buff.crit)" );
