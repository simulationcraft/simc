...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "use_item,name=inscrutable_quantum_device,if=(cooldown.unholy_blight.remains|cooldown.dark_transformation.remains)&(pet.army_ghoul.active|pet.apoc_ghoul.active&(!talent.army_of_the_damned|death_knight.disable_aotd)|target.time_to_pct_20<5)|fight_remains<21", "Trinkets" );
