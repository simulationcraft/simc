...
void unholy( player_t* p )
{
  ...
  default_->add_action( "variable,name=major_procs_active,value=buff.marrowed_gemstone_enhancement.up|buff.thrill_seeker.up|buff.frenzied_monstrosity.up|buff.lead_by_example.up|buff.unholy_strength.up" );
