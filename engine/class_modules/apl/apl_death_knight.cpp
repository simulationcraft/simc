...
void frost( player_t* p )
{
  ...
  single_target->add_action( "howling_blast,if=variable.rime_buffs", "Single Target Rotation actions.single_target=obliterate,if=buff.killing_machine.react&variable.obliterate_buffs" );
