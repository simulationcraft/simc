...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "use_item,name=the_first_sigil,if=variable.major_cooldowns_active&(time>30|!equipped.inscrutable_quantum_device&!equipped.overwhelming_power_crystal)" );
