...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "use_item,name=fyralath_the_dreamrender,if=active_dot.mark_of_fyralath=active_enemies&(active_enemies<5|active_enemies>21|fight_remains<4)", "Trinkets" );
