...
void frost( player_t* p )
{
  ...
  trinkets->add_action( "use_item,slot=trinket1,if=!trinket.1.cast_time>0&variable.trinket_1_buffs&!variable.trinket_1_manual&((!variable.trinket_2_buffs&talent.breath_of_sindragosa&buff.breath_of_sindragosa.up|talent.obliteration)&buff.pillar_of_frost.remains>variable.trinket_1_duration%2&(talent.obliteration|buff.breath_of_sindragosa.up))&(!trinket.2.has_cooldown|trinket.2.cooldown.remains|variable.trinket_priority=1)", "Trinkets The trinket with the highest estimated value, will be used first and paired with Pillar of Frost." );
  trinkets->add_action( "use_item,slot=trinket2,if=!trinket.2.cast_time>0&variable.trinket_2_buffs&!variable.trinket_2_manual&((!variable.trinket_1_buffs&talent.breath_of_sindragosa&buff.breath_of_sindragosa.up|talent.obliteration)&buff.pillar_of_frost.remains>variable.trinket_2_duration%2&(talent.obliteration|buff.breath_of_sindragosa.up))&(!trinket.1.has_cooldown|trinket.1.cooldown.remains|variable.trinket_priority=2)" );
