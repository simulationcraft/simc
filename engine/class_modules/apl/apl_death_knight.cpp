...
void unholy( player_t* p )
{
  ...
  cooldowns->add_action( "soul_reaper,target_if=target.time_to_pct_35<5&(target.time_to_die>5&active_enemies<=3|set_bonus.tier28_4pc&buff.dark_transformation.active&active_enemies<=5&(!death_and_decay.ticking|covenant.night_fae))" );
