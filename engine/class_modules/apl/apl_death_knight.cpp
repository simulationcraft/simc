...
void unholy( player_t* p )
{
  ...
  san_trinkets->add_action( "do_treacherous_transmitter_task,use_off_gcd=1,if=buff.errant_manaforge_emission.remains<gcd|buff.cryptic_instructions.remains<gcd|buff.realigning_nexus_convergence_divergence.remains<gcd", "Trinkets San'layn" );
  ...
  trinkets->add_action( "do_treacherous_transmitter_task,use_off_gcd=1,if=buff.errant_manaforge_emission.remains<gcd|buff.cryptic_instructions.remains<gcd|buff.realigning_nexus_convergence_divergence.remains<gcd", "Trinkets Non-San'layn" );
