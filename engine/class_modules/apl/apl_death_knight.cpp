...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "do_treacherous_transmitter_task,use_off_gcd=1,if=buff.errant_manaforge_emission.up&buff.errant_manaforge_emission.remains<2&(pet.apoc_ghoul.active|!talent.apocalypse&buff.dark_transformation.up)|buff.cryptic_instructions.up&buff.cryptic_instructions.remains<2&(pet.apoc_ghoul.active|!talent.apocalypse&buff.dark_transformation.up)|buff.realigning_nexus_convergence_divergence.up&buff.realigning_nexus_convergence_divergence.remains<2&(pet.apoc_ghoul.active|!talent.apocalypse&buff.dark_transformation.up)", "Trinkets Non-San'layn" );
