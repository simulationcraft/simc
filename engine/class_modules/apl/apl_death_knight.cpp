...
void frost( player_t* p )
{
  ...
  trinkets->add_action( "use_item,slot=trinket1,if=trinket.1.has_use_buff&(buff.pillar_of_frost.up&(!trinket.2.has_use_buff|trinket.2.cooldown.remains|trinket.1.proc.any_dps.duration>=fight_remains|((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))>((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)", "Estimates a trinkets value by comparing the cooldown of the trinket, divided by the duration of the buff it provides. Has a strength modifier to give a higher priority to strength trinkets. The trinket with the highest estimated value, will be used first and paired with Pillar of Frost." );
  trinkets->add_action( "use_item,slot=trinket2,if=trinket.2.has_use_buff&(buff.pillar_of_frost.up&(!trinket.1.has_use_buff|trinket.1.cooldown.remains|trinket.2.proc.any_dps.duration>=fight_remains|((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))>((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)" );
...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "use_item,slot=trinket1,if=trinket.1.has_use_buff&((trinket.1.proc.any_dps.duration<=15&cooldown.apocalypse.remains|trinket.1.proc.any_dps.duration>15&(cooldown.unholy_blight.remains|cooldown.dark_transformation.remains))&(!trinket.2.has_use_buff|trinket.2.cooldown.remains|trinket.1.proc.any_dps.duration>=fight_remains|((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))>((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)", "Estimates a trinkets value by comparing the cooldown of the trinket, divided by the duration of the buff it provides. Has a strength modifier to give a higher priority to strength trinkets. The trinket with the highest estimated value, will be used first and paired with Apocalypse (if buff is 15 seconds or less) or Blight/DT (if greater than 15 seconds)" );
  trinkets->add_action( "use_item,slot=trinket2,if=trinket.2.has_use_buff&((trinket.2.proc.any_dps.duration<=15&cooldown.apocalypse.remains|trinket.2.proc.any_dps.duration>15&(cooldown.unholy_blight.remains|cooldown.dark_transformation.remains))&(!trinket.1.has_use_buff|trinket.1.cooldown.remains|trinket.2.proc.any_dps.duration>=fight_remains|((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))>((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)" );
  trinkets->add_action( "use_item,slot=trinket1,if=!trinket.1.has_use_buff&trinket.2.cooldown.remains", "If only one on use trinket provides a buff, use the other on cooldown" );
  trinkets->add_action( "use_item,slot=trinket2,if=!trinket.2.has_use_buff&trinket.1.cooldown.remains" );
  trinkets->add_action( "use_items,if=!trinket.1.has_use_buff&!trinket.2.has_use_buff", "If neither trinket provides a buff, use both on cooldown." );
}
