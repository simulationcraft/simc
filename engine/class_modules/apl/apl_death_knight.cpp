...
void unholy( player_t* p )
{
  ...
  default_->add_action( "call_action_list,name=racials" );
  default_->add_action( "sequence,if=active_enemies=1&!death_knight.disable_aotd&talent.summon_gargoyle,name=garg_opener:army_of_the_dead:outbreak:festering_strike:festering_strike:apocalypse:summon_gargoyle:dark_transformation:unholy_assault:death_coil:death_coil:unholy_blight:empower_rune_weapon" );
  default_->add_action( "sequence,if=active_enemies=1&!death_knight.disable_aotd&!talent.summon_gargoyle,name=opener:festering_strike,if=!talent.unholy_assault:festering_strike,if=!talent.unholy_assault:unholy_blight:unholy_assault:potion:apocalypse:dark_transformation" );
  ...
  aoe_setup->add_action( "plaguebearer,target_if=max:debuff.festering_wound.stack,if=active_enemies>=2&debuff.festering_wound.stack>=4" );
  ...
  cooldowns->add_action( "dark_transformation,if=variable.st_planning&(talent.commander_of_the_dead&(pet.apoc_ghoul.active&cooldown.summon_gargoyle.remains>20|pet.gargoyle.active|!talent.summon_gargoyle&!talent.apocalypse)|!talent.commander_of_the_dead)" );
  ...
  cooldowns->add_action( "empower_rune_weapon,if=variable.st_planning&(pet.gargoyle.active&pet.gargoyle.remains<=21|!talent.summon_gargoyle&talent.apocalypse&pet.apoc_ghoul.active|!talent.summon_gargoyle&!talent.apocalypse&buff.dark_transformation.up)|fight_remains<=21" );
  ...
  cooldowns->add_action( "unholy_assault,if=variable.st_planning&(!talent.apocalypse|cooldown.apocalypse.remains<5|talent.summon_gargoyle)" );
  ...
  generic->add_action( "wound_spender,if=debuff.festering_wound.stack>2&talent.unholy_assault&cooldown.unholy_assault.remains<8&cooldown.apocalypse.remains<8" );
  ...
  generic->add_action( "wound_spender,if=debuff.festering_wound.stack>3&!variable.pooling_runes&(cooldown.apocalypse.remains>rune.time_to_3|!talent.apocalypse)|debuff.festering_wound.up&fight_remains<(debuff.festering_wound.stack*gcd)" );
