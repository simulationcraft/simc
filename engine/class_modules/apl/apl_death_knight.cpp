...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "use_item,name=fyralath_the_dreamrender,if=dot.mark_of_fyralath.ticking&(active_enemies<3|!death_and_decay.ticking)&(raid_event.adds.remains<4|!raid_event.adds.exists&active_enemies<7|active_enemies>21)", "Trinkets" );
