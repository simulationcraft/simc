...
void frost( player_t* p )
{
  ...
  trinkets->add_action( "use_item,slot=trinket1,if=(buff.pillar_of_frost.up&(!trinket.2.has_use_buff|trinket.1.proc.any_dps.duration>=fight_remains|((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))>((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)" );
  trinkets->add_action( "use_item,slot=trinket2,if=(buff.pillar_of_frost.up&(!trinket.1.has_use_buff|trinket.2.proc.any_dps.duration>=fight_remains|((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))>((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)" );
...
void unholy( player_t* p )
{
  ...
  trinkets->add_action( "use_item,slot=trinket1,if=((trinket.1.proc.any_dps.duration<=15&cooldown.apocalypse.remains|trinket.1.proc.any_dps.duration>15&(cooldown.unholy_blight.remains|cooldown.dark_transformation.remains))&(!trinket.2.has_use_buff|trinket.1.proc.any_dps.duration>=fight_remains|((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))>((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)" );
  trinkets->add_action( "use_item,slot=trinket2,if=((trinket.1.proc.any_dps.duration<=15&cooldown.apocalypse.remains|trinket.1.proc.any_dps.duration>15&(cooldown.unholy_blight.remains|cooldown.dark_transformation.remains))&(!trinket.1.has_use_buff|trinket.2.proc.any_dps.duration>=fight_remains|((trinket.2.cooldown.duration%trinket.2.proc.any_dps.duration)*(1+trinket.2.has_stat.strength))>((trinket.1.cooldown.duration%trinket.1.proc.any_dps.duration)*(1+trinket.1.has_stat.strength))))&(!equipped.inscrutable_quantum_device|cooldown.inscrutable_quantum_device.remains)" );
  trinkets->add_action( "use_item,slot=trinket1,if=!trinket.1.has_use_buff&trinket.2.cooldown.remains" );
  trinkets->add_action( "use_item,slot=trinket2,if=!trinket.2.has_use_buff&trinket.1.cooldown.remains" );
  trinkets->add_action( "use_items,if=!trinket.1.has_use_buff&!trinket.2.has_use_buff" );
}
