...
void unholy( player_t* p )
{
  ...
  default_->add_action( "army_of_the_dead,if=talent.summon_gargoyle&cooldown.summon_gargoyle.remains<3|!talent.summon_gargoyle", "Prioritize Army, Outbreak and Maintaining Plaguebringer" );
