...
void unholy( player_t* p )
{
  ...
  generic->add_action( "any_dnd,if=active_enemies>=2&death_knight.fwounded_targets=active_enemies|covenant.night_fae|runeforge.phearomones" );
