...
void frost( player_t* p )
{
  ...
  breath->add_action( "death_and_decay,if=talent.unholy_ground&!death_and_decay.ticking&runic_power.deficit>=10&!variable.2h_check|runic_power<36&rune.time_to_2>runic_power%18" );
  breath->add_action( "howling_blast,if=!talent.unholy_ground|variable.2h_check&runic_power<36&rune.time_to_2>runic_power%18" );
