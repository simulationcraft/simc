...
void havoc( player_t* p )
{
  ...
  default_->add_action( "fel_rush,if=talent.exergy&cooldown.eye_beam.remains<gcd.max*2" );
  ...
  meta->add_action( "fel_rush,if=talent.exergy&buff.exergy.remains<gcd.max*2" );
  ...
  meta->add_action( "fel_rush,if=talent.exergy" );
  ...
  opener->add_action( "fel_rush,if=talent.exergy&buff.exergy.remains<6&debuff.essence_break.down" );
