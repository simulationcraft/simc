...
void vengeance( player_t* p )
{
  ...
  maintenance->add_action( "use_items,if=time>5" );
  maintenance->add_action( "potion,if=variable.frailty_ready" );
  ...
  maintenance->add_action( "metamorphosis,if=talent.demonic&!cooldown.fel_devastation.up&fury>=50" );

  single_target->add_action( "soul_carver,if=variable.fd&(!talent.soulcrush|variable.frailty_ready)&soul_fragments<=3" );
  single_target->add_action( "the_hunt,if=!talent.soulcrush|variable.frailty_ready" );
  single_target->add_action( "soul_carver,if=!(talent.soulcrush|variable.frailty_ready)&soul_fragments<=3" );
  single_target->add_action( "fel_devastation,if=(!talent.soulcrush|variable.frailty_ready)&(variable.fd&!buff.metamorphosis.up)" );
  single_target->add_action( "elysian_decree,if=!talent.soulcrush|variable.frailty_ready" );
  single_target->add_action( "fracture,if=set_bonus.tier30_4pc&variable.fd&soul_fragments<=3" );
  single_target->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=4)|soul_fragments>=5)&(!cooldown.fel_devastation.up|fury>=90)" );
  single_target->add_action( "fel_devastation,if=!buff.metamorphosis.up" );
  single_target->add_action( "fracture,if=set_bonus.tier30_4pc&variable.fd" );
  single_target->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=3)|soul_fragments>=4)&(!cooldown.fel_devastation.up|fury>=90)" );
  single_target->add_action( "soul_cleave,if=talent.focused_cleave&(!cooldown.fel_devastation.up|(fury>=80))" );
  single_target->add_action( "fracture,if=soul_fragments<=3" );
  single_target->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=2)|soul_fragments>=3)&(!cooldown.fel_devastation.up|fury>=90)" );
  single_target->add_action( "soul_cleave" );
  single_target->add_action( "call_action_list,name=filler" );

  small_aoe->add_action( "elysian_decree,if=!talent.soulcrush|variable.frailty_ready" );
  small_aoe->add_action( "the_hunt,if=!talent.soulcrush|variable.frailty_ready" );
  small_aoe->add_action( "fel_devastation,if=(!talent.soulcrush|variable.frailty_ready)&(variable.fd&!buff.metamorphosis.up)" );
  small_aoe->add_action( "soul_carver,if=variable.fd&(!talent.soulcrush|variable.frailty_ready)&soul_fragments<=3" );
  small_aoe->add_action( "fracture,if=set_bonus.tier30_4pc&variable.fd&soul_fragments<=3&soul_fragments>=1" );
  small_aoe->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=4)|soul_fragments>=5)&(!cooldown.fel_devastation.up|fury>=90)" );
  small_aoe->add_action( "fel_devastation,if=!buff.metamorphosis.up" );
  small_aoe->add_action( "soul_carver,if=!(talent.soulcrush|variable.frailty_ready)&soul_fragments<=3" );
  small_aoe->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=3)|soul_fragments>=4)&(!cooldown.fel_devastation.up|fury>=90)" );
  small_aoe->add_action( "fracture,if=soul_fragments>=2&soul_fragments<=3" );
  small_aoe->add_action( "soul_cleave,if=talent.focused_cleave&(!cooldown.fel_devastation.up|(fury>=80))&cooldown.fracture.charges_fractional<1" );
  small_aoe->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=2)|soul_fragments>=3)&(!cooldown.fel_devastation.up|fury>=90)" );
  small_aoe->add_action( "soul_cleave" );
  small_aoe->add_action( "call_action_list,name=filler" );

  big_aoe->add_action( "fel_devastation,if=(!talent.soulcrush|variable.frailty_ready)&variable.fd&!buff.metamorphosis.up&talent.stoke_the_flames" );
  big_aoe->add_action( "elysian_decree,if=!talent.soulcrush|variable.frailty_ready" );
  big_aoe->add_action( "the_hunt,if=!talent.soulcrush|variable.frailty_ready" );
  big_aoe->add_action( "fel_devastation,if=(!talent.soulcrush|variable.frailty_ready)&variable.fd&!buff.metamorphosis.up" );
  big_aoe->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=4)|soul_fragments>=5)&(!cooldown.fel_devastation.up|fury>=90)" );
  big_aoe->add_action( "fel_devastation,if=!buff.metamorphosis.up" );
  big_aoe->add_action( "fracture,if=set_bonus.tier30_4pc&variable.fd&soul_fragments<=3&soul_fragments>=1" );
  big_aoe->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=3)|soul_fragments>=4)&(!cooldown.fel_devastation.up|fury>=90)" );
  big_aoe->add_action( "soul_carver,if=variable.fd&(!talent.soulcrush|variable.frailty_ready)&soul_fragments<=3" );
  big_aoe->add_action( "spirit_bomb,if=((variable.fd&soul_fragments>=2)|soul_fragments>=3)&(!cooldown.fel_devastation.up|fury>=90)" );
  big_aoe->add_action( "fracture,if=soul_fragments>=1&soul_fragments<=3" );
  big_aoe->add_action( "soul_cleave,if=talent.focused_cleave&(!cooldown.fel_devastation.up|(fury>=80))" );
  big_aoe->add_action( "soul_carver,if=!(talent.soulcrush|variable.frailty_ready)&soul_fragments<=3" );
