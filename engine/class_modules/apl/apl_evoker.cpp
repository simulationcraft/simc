...
void devastation( player_t* p )
{
  ...
  trinkets->add_action( "use_item,name=iridal_the_earths_master,use_off_gcd=1,if=gcd.remains>0|fight_remains<20", "Use Iridal off-GCD or if the fight will end soon." );
