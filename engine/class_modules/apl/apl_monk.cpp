...
namespace monk_apl
{
  ...
  void windwalker( player_t *p )
  {
    ...
    def->add_action( "jadefire_stomp,target_if=min:debuff.fae_exposure_damage.remains,if=combo_strike&talent.jadefire_harmony&debuff.fae_exposure_damage.remains<1", "Prioritize jadefire Stomp if playing with jadefire Harmony" );
    ...
    opener->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2&!debuff.skyreach_exhaustion.remains<2&!debuff.skyreach_exhaustion.remains" );
    ...
    serenity_aoelust->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<1", "Serenity AoE Lust" );
    ...
    serenity_aoelust->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2" );
    ...
    serenity_lust->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<1", "Serenity Lust" );
    ...
    serenity_aoe->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<1", "Serenity >4 Targets" );
    ...
    serenity_aoe->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2" );
    ...
    // Serenity 4 Target Priority
    serenity_4t->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<1", "Serenity 4 Targets" );
    ...
    serenity_4t->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2" );
    ...
    serenity_3t->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<1", "Serenity 3 Targets" );
    ...
    serenity_3t->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2" );
    ...
    serenity_2t->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2&!debuff.skyreach_exhaustion.remains<2&!debuff.skyreach_exhaustion.remains", "Serenity 2 Targets" );
    ...
    serenity_st->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2&!debuff.skyreach_exhaustion.remains", "Serenity 1 Target" );
    ...
    serenity_st->add_action( "jadefire_stomp,if=debuff.fae_exposure_damage.remains<2" );
    ...
    default_st->add_action( "fists_of_fury,if=!buff.pressure_point.up&debuff.skyreach_exhaustion.remains<55&(debuff.fae_exposure_damage.remains>2|cooldown.jadefire_stomp.remains)");
    default_st->add_action( "jadefire_stomp,if=debuff.skyreach_exhaustion.remains<1&debuff.fae_exposure_damage.remains<3" );
