...
namespace monk_apl
{
  ...
  void windwalker( player_t *p )
  {
    ...
    cd_serenity->add_action( "invoke_xuen_the_white_tiger,if=(target.time_to_die>25|(fight_style.dungeonslice|fight_style.dungeonroute)&cooldown.serenity.remains<2)&fight_remains>120&((trinket.1.is.ashes_of_the_embersoul|trinket.1.is.witherbark_branch)&!trinket.1.cooldown.remains|(trinket.2.is.ashes_of_the_embersoul|trinket.2.is.witherbark_branch)&!trinket.2.cooldown.remains)" );
