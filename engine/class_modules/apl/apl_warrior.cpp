...
void arms( player_t* p )
{
  ...
  slayer_execute->add_action( "mortal_strike,if=buff.executioners_precision.stack=2&(dot.rend.remains<2|buff.martial_prowess.stack=3|buff.fierce_followthrough.up)" );
