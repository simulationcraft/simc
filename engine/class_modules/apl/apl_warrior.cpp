...
void fury( player_t* p )
{
  ...
  slayer->add_action( "rampage,if=buff.recklessness.up&rage>=100" );
  slayer->add_action( "rampage,if=buff.recklessness.up&cooldown.bladestorm.ready" );
  slayer->add_action( "bladestorm,if=buff.recklessness.up|target.time_to_die<=5" );
  slayer->add_action( "execute,if=buff.recklessness.up&buff.sudden_death.up" );
  slayer->add_action( "rampage,if=buff.recklessness.up&!buff.hack_and_slash.up" );
  slayer->add_action( "crushing_blow" );
  slayer->add_action( "odyns_fury,if=buff.recklessness.up" );
  slayer->add_action( "execute,if=buff.recklessness.up" );
  slayer->add_action( "bloodbath" );
  slayer->add_action( "odyns_fury,if=buff.recklessness.up" );
  slayer->add_action( "rampage,if=rage>100" );
  ...
  slayer_aoe->add_action( "bladestorm,if=buff.recklessness.up|target.time_to_die<=5" );
  ...
  thane->add_action( "bloodbath,if=buff.recklessness.up&buff.fury_mid2_4pc_crit.stack<2" );
  thane->add_action( "thunder_blast,if=buff.thunder_blast.stack=2|buff.avatar.remains<2|buff.thunder_blast.remains<2" );
  thane->add_action( "crushing_blow,if=buff.hack_and_slash.up" );
  ...
  thane->add_action( "raging_blow,if=buff.hack_and_slash.up" );
  ...
  thane_aoe->add_action( "rampage,if=!buff.enrage.up" );
  ...
  thane_aoe->add_action( "crushing_blow,if=buff.hack_and_slash.up" );
  ...
  thane_aoe->add_action( "thunder_blast" );
  thane_aoe->add_action( "raging_blow,if=buff.hack_and_slash.up" );
...
void arms( player_t* p )
{
  ...
  colossus_aoe->add_action( "mortal_strike,if=buff.colossal_might.stack<10" );
  colossus_aoe->add_action( "demolish" );
  ...
  colossus_aoe->add_action( "execute,if=talent.deep_wounds" );
  ...
  colossus_execute->add_action( "avatar,if=debuff.colossus_smash.up|cooldown.colossus_smash.remains<10&cooldown.colossus_smash.remains>gcd" );
  colossus_execute->add_action( "ravager,if=cooldown.colossus_smash.remains<2" );
  ...
  colossus_execute->add_action( "mortal_strike,if=buff.colossal_might.stack<10|buff.executioners_precision.stack=2" );
  ...
  colossus_st->add_action( "sweeping_strikes,if=active_enemies=2" );
  colossus_st->add_action( "mortal_strike,if=buff.colossal_might.stack<10" );
  colossus_st->add_action( "cleave,if=dot.rend_dot.remains<=gcd|cooldown.colossus_smash.remains<2&dot.rend_dot.remains<=10" );
  colossus_st->add_action( "rend,if=!talent.cleave&dot.rend_dot.remains<=gcd|cooldown.colossus_smash.remains<2&dot.rend_dot.remains<=10&!talent.cleave" );
  colossus_st->add_action( "ravager,if=cooldown.colossus_smash.remains<2" );
  colossus_st->add_action( "execute,if=buff.sudden_death.stack=2&cooldown.colossus_smash.remains<2&talent.tactical_edge" );
  colossus_st->add_action( "avatar,if=debuff.colossus_smash.up|cooldown.colossus_smash.remains>gcd" );
  colossus_st->add_action( "colossus_smash" );
  colossus_st->add_action( "champions_spear" );
  colossus_st->add_action( "demolish,if=buff.colossal_might.up&debuff.colossus_smash.up" );
  colossus_st->add_action( "heroic_strike" );
  colossus_st->add_action( "execute,if=buff.sudden_death.stack=2" );
  colossus_st->add_action( "mortal_strike" );
  colossus_st->add_action( "cleave,if=buff.collateral_damage.stack=3" );
  colossus_st->add_action( "execute" );
  colossus_st->add_action( "overpower" );
  colossus_st->add_action( "cleave,if=dot.rend_dot.remains<=gcd*5" );
  colossus_st->add_action( "rend,if=!talent.cleave&dot.rend_dot.remains<=gcd*5" );
  colossus_st->add_action( "bladestorm,if=active_enemies=2" );
  colossus_st->add_action( "slam" );
  colossus_st->add_action( "wrecking_throw" );

  slayer_aoe->add_action( "cleave,if=!dot.rend_dot.remains&talent.rend" );
  slayer_aoe->add_action( "sweeping_strikes" );
  slayer_aoe->add_action( "avatar" );
  slayer_aoe->add_action( "ravager,if=debuff.colossus_smash.up" );
  slayer_aoe->add_action( "execute,if=buff.sudden_death.stack=2&cooldown.colossus_smash.remains<2" );
  ...
  slayer_aoe->add_action( "execute,if=buff.sudden_death.stack=2" );
  ...
  slayer_execute->add_action( "cleave,if=dot.rend_dot.remains<2&!talent.bloodletting" );
  slayer_execute->add_action( "rend,if=dot.rend_dot.remains<2&!talent.bloodletting&!talent.cleave" );
  slayer_execute->add_action( "avatar,if=debuff.colossus_smash.up|cooldown.colossus_smash.remains>gcd|target.time_to_die<=20" );
  ...
  slayer_execute->add_action( "cleave,if=buff.collateral_damage.stack=3" );
  ...
  slayer_st->add_action( "cleave,if=dot.rend_dot.remains<=gcd|cooldown.colossus_smash.remains<2&dot.rend_dot.remains<=10" );
  slayer_st->add_action( "rend,if=!talent.cleave&(dot.rend_dot.remains<=gcd&active_enemies<2|cooldown.colossus_smash.remains<2&dot.rend_dot.remains<=10&active_enemies<2)" );
  slayer_st->add_action( "avatar,if=debuff.colossus_smash.up|cooldown.colossus_smash.remains<10&cooldown.colossus_smash.remains>gcd" );
  slayer_st->add_action( "ravager,if=cooldown.colossus_smash.remains<=gcd" );
  slayer_st->add_action( "execute,if=buff.sudden_death.stack=2|cooldown.bladestorm.ready&buff.imminent_demise.stack<1" );
  slayer_st->add_action( "colossus_smash,if=buff.sudden_death.stack<2" );
  slayer_st->add_action( "bladestorm,if=debuff.colossus_smash.up|buff.avatar.up" );
  slayer_st->add_action( "heroic_strike" );
  slayer_st->add_action( "overpower,if=buff.opportunist.stack=2&talent.opportunist" );
  slayer_st->add_action( "cleave,if=buff.collateral_damage.stack=3&active_enemies=2" );
  slayer_st->add_action( "mortal_strike" );
  slayer_st->add_action( "execute,if=buff.sudden_death.up&buff.executioner.up" );
  slayer_st->add_action( "overpower" );
  slayer_st->add_action( "cleave,if=active_enemies=2|dot.rend_dot.remains<=5" );
  slayer_st->add_action( "rend,if=!talent.cleave&dot.rend_dot.remains<=5" );
...
void protection( player_t* p )
{
  ...
  default_->add_action( "thunder_blast,if=talent.booming_voice.enabled&buff.thunder_blast.stack=2&talent.snap_induction.enabled" );
  ...
  colossus_aoe->add_action( "shield_slam,if=buff.phalanx.up&(buff.violent_outburst.up|rage<30)" );
  colossus_aoe->add_action( "thunder_clap,if=rage<30" );
  colossus_aoe->add_action( "revenge,if=spell_targets.revenge>=3" );
  colossus_aoe->add_action( "shield_slam" );
  colossus_aoe->add_action( "thunder_clap" );
  colossus_aoe->add_action( "revenge,if=rage>=30" );
  ...
  colossus_st->add_action( "thunder_clap,if=!buff.phalanx.up" );
  colossus_st->add_action( "execute" );
  colossus_st->add_action( "revenge,if=buff.revenge.up" );
  ...
  thane_aoe->add_action( "thunder_clap" );
  thane_aoe->add_action( "revenge,if=buff.revenge.up" );
  thane_aoe->add_action( "shield_slam" );
  thane_aoe->add_action( "revenge" );
  thane_aoe->add_action( "execute,if=spell_targets.execute=3&(rage>=50|buff.sudden_death.up)&talent.heavy_handed.enabled" );
  ...
  thane_st->add_action( "revenge,if=buff.revenge.up" );
