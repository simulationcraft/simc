...
void fire( player_t* p )
{
  ...
  combustion_phase->add_action( "phoenix_flames,if=set_bonus.tier30_2pc&!action.phoenix_flames.in_flight&debuff.charring_embers.remains<4*gcd.max&!buff.hot_streak.react", "In Charring embers is not up before Combustion, make sure to apply it." );
