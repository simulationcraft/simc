...
void arcane( player_t* p )
{
  ...
  default_->add_action( "use_item,name=belorrelos_the_suncaller,use_off_gcd=1,if=gcd.remains&!dot.radiant_spark.remains&(!variable.steroid_trinket_equipped|buff.siphon_storm.down)" );
  ...
  rotation->add_action( "nether_tempest,if=equipped.belorrelos_the_suncaller&cooldown.belorrelos_the_suncaller.ready&buff.siphon_storm.down&buff.arcane_surge.down,line_cd=120" );
