...
void arcane( player_t* p )
{
  ...
  spellslinger->add_action( "arcane_barrage,if=buff.nether_precision.stack=1&time-action.arcane_blast.last_used<0.015", "Always queue Arcane Barrage on the second stack of Nether Precision as Spellslinger" );
