...
void fire( player_t* p )
{
  ...
  default_->add_action( "radiant_spark,if=buff.combustion.down&(variable.time_to_combustion<2*gcd.max|variable.time_to_combustion>cooldown-10)" );
  default_->add_action( "deathborne,if=buff.combustion.down&buff.rune_of_power.down&variable.time_to_combustion<execute_time" );
  default_->add_action( "mirrors_of_torment,if=variable.time_to_combustion<=4&buff.combustion.down" );
  ...
  default_->add_action( "frost_nova,if=runeforge.grisly_icicle&buff.combustion.down&(variable.time_to_combustion>cooldown|variable.time_to_combustion<execute_time)", "Use Frost Nova to trigger Grisly Icicle." );
  default_->add_action( "counterspell,if=runeforge.disciplinary_command&cooldown.buff_disciplinary_command.remains<action.frostbolt.cast_time&buff.disciplinary_command_arcane.down&!buff.disciplinary_command.up&(variable.time_to_combustion>20|variable.time_to_combustion<5)", "Get the Disciplinary Command buff up, unless combustion is soon." );
  default_->add_action( "arcane_explosion,if=runeforge.disciplinary_command&cooldown.buff_disciplinary_command.remains<execute_time+action.frostbolt.cast_time&buff.disciplinary_command_arcane.down&!buff.disciplinary_command.up&(variable.time_to_combustion>20|variable.time_to_combustion<5&!talent.rune_of_power)" );
  default_->add_action( "frostbolt,if=runeforge.disciplinary_command&cooldown.buff_disciplinary_command.remains<cast_time&buff.disciplinary_command_frost.down&!buff.disciplinary_command.up&(variable.time_to_combustion>20|variable.time_to_combustion<5)" );
