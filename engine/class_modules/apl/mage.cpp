...
void fire( player_t* p )
{
  ...
  default_->add_action( "phoenix_flames,if=((debuff.charring_embers.down|debuff.charring_embers.remains<=3)&!buff.hot_streak.react)&time<15&!action.phoenix_flames.in_flight" );
  ...
  combustion_phase->add_action( "phoenix_flames,if=buff.combustion.up&travel_time<buff.combustion.remains&buff.heating_up.react+hot_streak_spells_in_flight<2&!action.phoenix_flames.in_flight&(debuff.charring_embers.down|debuff.charring_embers.remains<=3|buff.flames_fury.up)&talent.alexstraszas_fury" );
  ...
  rop_phase->add_action( "phoenix_flames,if=buff.combustion.up&travel_time<buff.combustion.remains&buff.heating_up.react+hot_streak_spells_in_flight<2&!action.phoenix_flames.in_flight&(debuff.charring_embers.down|debuff.charring_embers.remains<=3|buff.flames_fury.up)" );
  ...
  rop_phase->add_action( "phoenix_flames,if=(debuff.charring_embers.down|debuff.charring_embers.remains<=3|buff.flames_fury.up)&(!hot_streak_spells_in_flight&!action.phoenix_flames.in_flight&(buff.heating_up.react|charges>1))&time>15&!buff.hot_streak.react&talent.alexstraszas_fury" );
  rop_phase->add_action( "phoenix_flames,if=(debuff.charring_embers.down|debuff.charring_embers.remains<=3|buff.flames_fury.up)&(hot_streak_spells_in_flight&!action.phoenix_flames.in_flight&(buff.heating_up.react|charges>1))&time>15&!buff.hot_streak.react&!talent.alexstraszas_fury" );
  ...
  standard_rotation->add_action( "phoenix_flames,if=(debuff.charring_embers.down|debuff.charring_embers.remains<=3|buff.flames_fury.up)&(!hot_streak_spells_in_flight&!action.phoenix_flames.in_flight&(buff.heating_up.react|charges>1))&!buff.hot_streak.react&talent.alexstraszas_fury" );
  standard_rotation->add_action( "phoenix_flames,if=(debuff.charring_embers.down|debuff.charring_embers.remains<=3|buff.flames_fury.up&cooldown.rune_of_power.remains>10)&(hot_streak_spells_in_flight&!action.phoenix_flames.in_flight&(buff.heating_up.react|charges>1))&!buff.hot_streak.react&!talent.alexstraszas_fury" );
