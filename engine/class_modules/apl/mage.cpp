...
void fire( player_t* p )
{
  ...
  combustion_phase->add_action( "shifting_power,if=buff.combustion.up&!action.fire_blast.charges,interrupt_if=action.fire_blast.charges=action.fire_blast.max_charges" );
