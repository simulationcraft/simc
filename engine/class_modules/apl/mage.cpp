...
void fire( player_t* p )
{
  ...
  default_->add_action( "call_action_list,name=combustion_phase,if=talent.spellfire_spheres&(variable.time_to_combustion<=0|buff.combustion.up|variable.time_to_combustion<variable.combustion_precast_time&cooldown.combustion.remains<variable.combustion_precast_time)" );
  default_->add_action( "call_action_list,name=combustion_phase,if=talent.frostfire_bolt&(variable.time_to_combustion<=0|buff.combustion.up|variable.time_to_combustion<variable.combustion_precast_time&cooldown.combustion.remains<variable.combustion_precast_time)" );
  ...
  default_->add_action( "call_action_list,name=standard_rotation,if=talent.spellfire_spheres&variable.time_to_combustion>0&buff.combustion.down" );
  default_->add_action( "call_action_list,name=standard_rotation,if=talent.frostfire_bolt&variable.time_to_combustion>0&buff.combustion.down" );
