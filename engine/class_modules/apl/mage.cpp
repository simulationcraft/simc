...
void arcane( player_t* p )
{
  ...
  default_->add_action( "use_item,name=timebreaching_talon,if=(((variable.totm_on_last_spark_stack&cooldown.arcane_surge.remains<=(gcd.max*4)&cooldown.radiant_spark.remains)|(!variable.totm_on_last_spark_stack&prev_gcd.1.arcane_surge))&(!variable.irideus_double_on_use|!buff.bloodlust.up))|fight_remains<=20" );
  ...
  default_->add_action( "use_item,name=mirror_of_fractured_tomorrows,if=(((variable.totm_on_last_spark_stack&cooldown.arcane_surge.remains<=(gcd.max*4)&cooldown.radiant_spark.remains>0)|(!variable.totm_on_last_spark_stack&prev_gcd.1.arcane_surge))&(!variable.balefire_double_on_use|!buff.bloodlust.up))|fight_remains<=20" );
  ...
  default_->add_action( "use_item,name=ashes_of_the_embersoul,if=(((variable.totm_on_last_spark_stack&cooldown.arcane_surge.remains<=(gcd.max*4)&cooldown.radiant_spark.remains>0)|(!variable.totm_on_last_spark_stack&prev_gcd.1.arcane_surge))&(!variable.mirror_double_on_use|!buff.bloodlust.up)&(!variable.balefire_double_on_use|!buff.bloodlust.up))|fight_remains<=20" );
  default_->add_action( "use_item,name=nymues_unraveling_spindle,if=(((!variable.opener&variable.totm_on_last_spark_stack&cooldown.arcane_surge.remains<=(gcd.max*7)&cooldown.radiant_spark.ready)|(!variable.totm_on_last_spark_stack&cooldown.arcane_surge.remains<=(gcd.max*4)&cooldown.radiant_spark.ready)|(variable.opener&variable.totm_on_last_spark_stack&buff.bloodlust.up&mana<=variable.opener_min_mana))&(!variable.mirror_double_on_use|!buff.bloodlust.up)&(!variable.balefire_double_on_use|!buff.bloodlust.up)&(!variable.ashes_double_on_use|!buff.bloodlust.up)&(!variable.nymues_double_on_use|!buff.bloodlust.up))|fight_remains<=24" );
  default_->add_action( "use_item,name=sea_star,if=(((variable.totm_on_last_spark_stack&cooldown.arcane_surge.remains<=(gcd.max*4)&cooldown.radiant_spark.remains>0)|(!variable.totm_on_last_spark_stack&prev_gcd.1.arcane_surge))&(!variable.mirror_double_on_use|!buff.bloodlust.up)&(!variable.balefire_double_on_use|!buff.bloodlust.up)&(!variable.ashes_double_on_use|!buff.bloodlust.up))|fight_remains<=20" );
  ...
  default_->add_action( "variable,name=surge_last_spark_stack,op=set,if=action.arcane_blast.cast_time>=gcd.max,value=0" );
  default_->add_action( "variable,name=surge_last_spark_stack,op=set,if=action.arcane_blast.cast_time<gcd.max,value=1" );
  ...
  cooldown_phase->add_action( "wait,sec=0.05,if=prev_gcd.1.arcane_surge,line_cd=15", "Waits are used to simulate players allowing radiant spark to increment in stacks" );
  ...
  cooldown_phase->add_action( "cancel_action,if=action.arcane_missiles.channeling&gcd.remains=0&mana.pct>30&buff.nether_precision.up", "Canceling missile channels as soon as blast is ready to cast" );
  ...
  spark_phase->add_action( "wait,sec=0.05,if=action.arcane_blast.execute_remains<gcd.remains&(talent.nether_tempest&prev_gcd.6.radiant_spark)|(!talent.nether_tempest&prev_gcd.5.radiant_spark),line_cd=15", "Waits are used to simulate players allowing radiant spark to increment in stacks" );
