...
void frost( player_t* p )
{
  ...
  cds->add_action( "water_jet,use_off_gcd=1,use_while_casting=1,if=talent.frostfire_bolt|active_enemies>2|talent.splinterstorm&(cooldown.flurry.charges<1|buff.icy_veins.remains<2)" );
