...
void outlaw( player_t* p )
{
  ...
  cds->add_action( "keep_it_rolling,if=rtb_buffs.normal>=5&rtb_buffs=6", "With a natural 5 buff roll, use Keep it Rolling when you obtain the remaining buff from Count the Odds." );
