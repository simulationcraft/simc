...
void outlaw( player_t* p )
{
  ...
  build->add_action( "pistol_shot,if=talent.fan_the_hammer&buff.opportunity.up&combo_points.deficit>=((1+talent.quick_draw+buff.broadside.up)*talent.fan_the_hammer.rank)", "With Fan the Hammer, consume Opportunity based on CP deficit to ensure minimal CP overcapping" );
