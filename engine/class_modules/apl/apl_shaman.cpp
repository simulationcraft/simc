...
void elemental( player_t* p )
{
  ...
  single_target->add_action( "elemental_blast,if=buff.flowing_elements.up&buff.overcharge_tier.up", "Consume tier procs if you gona proc new one with next builder." );
