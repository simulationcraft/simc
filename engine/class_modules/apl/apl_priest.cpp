...
void shadow( player_t* p )
{
  ...
  main->add_action( "call_action_list,name=empowered_filler,if=(buff.mind_spike_insanity.stack=1&talent.mind_spike|buff.mind_flay_insanity.stack=1&!talent.mind_spike|buff.power_surge.up)&talent.empowered_surges&!cooldown.void_eruption.up", "Do not overcap MSI or MFI during Empowered Surges (Archon)." );
