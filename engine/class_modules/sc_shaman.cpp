...
void shaman_t::init_action_list_enhancement()
{
  ...
  aoe->add_action(this, "Crash Lightning", "if=talent.crashing_storm.enabled|buff.crash_lightning.down|buff.doom_winds.up");
  aoe->add_action("chain_harvest,if=buff.maelstrom_weapon.stack>=5");
  aoe->add_talent(this, "Sundering", "if=runeforge.doom_winds.equipped&buff.doom_winds.up");
  aoe->add_talent(this, "Ice Strike", "if=buff.hailstorm.down");
  ...
  aoe->add_action(this, "Chain Lightning", "if=buff.doom_winds.up");
