...
void priest_t::generate_apl_holy_d()
{
    ...
    // Default APL
    default_list->add_action( this, "Holy Fire", "if=refreshable&dot.holy_fire.ticking&dot.holy_fire.stack>1|dot.holy_fire.stack<2", "If you have 2 stacks of the Holy Fire debuff on your target, refresh the buff as late as possible. If not use Holy Fire instantly.");
