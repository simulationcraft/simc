...
void death_knight_t::default_apl_unholy()
{
  ...
  def -> add_action( "use_item,name=ashvanes_razor_coral,if=(pet.guardian_of_azeroth.active&buff.unholy_frenzy.up)|(cooldown.apocalypse.remains<2&!essence.condensed_lifeforce.enabled&!talent.unholy_frenzy.enabled)|(target.1.time_to_die<cooldown.apocalypse.remains+20)|(cooldown.apocalypse.remains<2&target.1.time_to_die<cooldown.condensed_lifeforce.remains+20)" );
  ...
  essences -> add_action( "guardian_of_azeroth,if=cooldown.apocalypse.remains<6" );
  essences -> add_action( "the_unbound_force,if=buff.reckless_force.up|buff.reckless_force_counter.stack<11" );
  ...
  cooldowns -> add_talent( this, "Unholy Frenzy", "if=essence.vision_of_perfection.enabled|(essence.condensed_lifeforce.enabled&cooldown.apocalypse.remains<2)|debuff.festering_wound.stack<4&!(equipped.ramping_amplitude_gigavolt_engine|azerite.magus_of_the_dead.enabled)|cooldown.apocalypse.remains<2&(equipped.ramping_amplitude_gigavolt_engine|azerite.magus_of_the_dead.enabled)" );
