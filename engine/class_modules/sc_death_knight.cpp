...
void death_knight_t::default_apl_unholy()
{
  ...
  def -> add_action( "use_item,name=ashvanes_razor_coral,if=(pet.guardian_of_azeroth.active&buff.unholy_frenzy.up)|(buff.unholy_frenzy.up&!essence.condensed_lifeforce.enabled)|(buff.unholy_frenzy.up&cooldown.army_of_the_dead.remains<360)|(cooldown.apocalypse.remains<2&!talent.unholy_frenzy.enabled)" );
