...
void death_knight_t::default_apl_unholy()
{
  ...
  cooldowns -> add_action( this, "Apocalypse", "if=debuff.festering_wound.stack>=4&active_enemies=1&talent.unholy_blight&conduit.convocation_of_the_dead.rank>=5&talent.army_of_the_damned&runeforge.deadliest_coil&dot.unholy_blight.remains", "Use Apocalypse after Blight with specific setups, failsafe incase Apoc CD is lower than Blight" );
  cooldowns -> add_action( this, "Apocalypse", "if=debuff.festering_wound.stack>=4&active_enemies=1&talent.unholy_blight&!talent.army_of_the_damned&dot.unholy_blight.remains", "Hold Apoc for Blight if using Gargoyle or Unholy Assault" );
