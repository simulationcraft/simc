...
void death_knight_t::default_apl_frost()
{
  ...
  // Choose APL
  def -> add_action( "call_action_list,name=cooldowns", "Action List Calls" );
  def -> add_action( "call_action_list,name=cold_heart,if=talent.cold_heart.enabled&(buff.cold_heart.stack>=10&(debuff.razorice.stack=5&death_knight.runeforge.razorice|!death_knight.runeforge.razorice)|target.1.time_to_die<=gcd)" );
  ...
  // In-combat potion
  def -> add_action( "potion,if=buff.pillar_of_frost.up&buff.empower_rune_weapon.up" );

  // Racials
  def -> add_action( "blood_fury,if=buff.pillar_of_frost.up&buff.empower_rune_weapon.up", "Racial Abilties" );
  def -> add_action( "berserking,if=buff.pillar_of_frost.up" );
  def -> add_action( "arcane_pulse,if=(!buff.pillar_of_frost.up&active_enemies>=2)|!buff.pillar_of_frost.up&(rune.deficit>=5&runic_power.deficit>=60)" );
  def -> add_action( "lights_judgment,if=buff.pillar_of_frost.up" );
  def -> add_action( "ancestral_call,if=buff.pillar_of_frost.up&buff.empower_rune_weapon.up" );
  def -> add_action( "fireblood,if=buff.pillar_of_frost.remains<=8&buff.empower_rune_weapon.up" );
  ...
  cooldowns -> add_talent( this, "Hypothermic Presence", "if=talent.breath_of_sindragosa.enabled&runic_power.defecit>40&rune>=3|!talent.breath_of_sindragosa.enabled&runic_power.deficit>=25" );
  ...
  bos_pooling -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power.deficit>=25&!talent.frostscythe.enabled" );
  ...
  bos_pooling -> add_action( this, "Frost Strike", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power.deficit<20&!talent.frostscythe.enabled&cooldown.pillar_of_frost.remains>5" );
  ...
  bos_pooling -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power.deficit>=(35+talent.runic_attenuation.enabled*3)&!talent.frostscythe.enabled" );
  ...
  bos_pooling -> add_action( this, "Frost Strike", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&cooldown.pillar_of_frost.remains>rune.time_to_4&runic_power.deficit<40&!talent.frostscythe.enabled" );
  ...
  bos_ticking -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power<=32&!talent.frostscythe.enabled" );
  ...
  bos_ticking -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&rune.time_to_5<gcd|runic_power<=45&!talent.frostscythe.enabled" );
  ...
  bos_ticking -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power.deficit>25|rune>3&!talent.frostscythe.enabled" );
  ...
  obliteration -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&!talent.frostscythe.enabled&!buff.rime.up&spell_targets.howling_blast>=3" );
  ...
  obliteration -> add_action( this, "Frost Strike", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&!buff.rime.up|runic_power.deficit<10|rune.time_to_2>gcd&!talent.frostscythe.enabled" );
  ...
  obliteration -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&!talent.frostscythe.enabled" );
  ...
  standard -> add_action( this, "Frost Strike", "if=runic_power.deficit<(15+talent.runic_attenuation.enabled*3)|buff.hypothermic_presence.active&talent.hypothermic_presence.active" );
  ...
  aoe -> add_action( this, "Frost Strike", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&cooldown.remorseless_winter.remains<=2*gcd&talent.gathering_storm.enabled&!talent.frostscythe.enabled" );
  ...
  aoe -> add_action( this, "Frost Strike", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power.deficit<(15+talent.runic_attenuation.enabled*3)&!talent.frostscythe.enabled" );
  ...
  aoe -> add_action( this, "Obliterate", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&runic_power.deficit>(25+talent.runic_attenuation.enabled*3)&!talent.frostscythe.enabled" );
  ...
  aoe -> add_action( this, "Frost Strike", "target_if=(death_knight.runeforge.razorice&(debuff.razorice.stack<5|debuff.razorice.remains<10))&!talent.frostscythe.enabled" );
...
void death_knight_t::default_apl_unholy()
{
  ...
  //  Variables
  // WIP, May change if gargoyle goes back to baseline.
  ...
  cooldowns -> add_action( this, "Apocalypse", "if=debuff.festering_wound.stack>=4&(!talent.unholy_blight.enabled|talent.unholy_blight.enabled&cooldown.unholy_blight.remains>5)" );
  ...
  generic -> add_action( this, "Scourge Strike", "if=debuff.festering_wound.up&!talent.unholy_blight.enabled&(cooldown.apocalypse.remains>5|debuff.festering_wound.stack>4)&variable.disable_aotd" );
  generic -> add_action( this, "Scourge Strike", "if=debuff.festering_wound.up&talent.unholy_blight.enabled&((cooldown.unholy_blight.remains>5&(cooldown.apocalypse.remains>5|cooldown.apocalypse.ready&!dot.unholy_blight.remains))|debuff.festering_wound.stack>4)&variable.disable_aotd" );
  generic -> add_talent( this, "Clawing Shadows", "if=debuff.festering_wound.up&!talent.unholy_blight.enabled&(cooldown.apocalypse.remains>5|debuff.festering_wound.stack>4)&variable.disable_aotd" );
  generic -> add_talent( this, "Clawing Shadows", "if=debuff.festering_wound.up&talent.unholy_blight.enabled&((cooldown.unholy_blight.remains>5&(cooldown.apocalypse.remains>5|cooldown.apocalypse.ready&!dot.unholy_blight.remains))|debuff.festering_wound.stack>4)&variable.disable_aotd" );
  generic -> add_action( this, "Death Coil", "if=runic_power.deficit<20&!variable.pooling_for_gargoyle" );
  generic -> add_action( this, "Festering Strike", "if=debuff.festering_wound.stack<4&((cooldown.apocalypse.remains<3&(!talent.unholy_blight.enabled|(talent.unholy_blight.enabled&(cooldown.unholy_blight.remains<3|dot.unholy_blight.remains))))|debuff.festering_wound.stack<1)&variable.disable_aotd|cooldown.army_of_the_dead.ready" );
  ...
  aoe -> add_action( this, "Epidemic", "if=death_and_decay.ticking&runic_power.deficit<(14+death_knight.fwounded_targets*3)&!variable.pooling_for_gargoyle" );
