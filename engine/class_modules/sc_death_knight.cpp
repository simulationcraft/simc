...
void death_knight_t::default_apl_unholy()
{
  ...
  def -> add_action( "use_item,name=azsharas_font_of_power,if=(cooldown.apocalypse.remains<=14&essence.condensed_lifeforce.major&equipped.ashvanes_razor_coral)|(target.1.time_to_die<cooldown.apocalypse.remains+34)" );
  def -> add_action( "use_item,name=azsharas_font_of_power,if=(!essence.condensed_lifeforce.major&!essence.vision_of_perfection.major)|(talent.army_of_the_damned.enabled&essence.vision_of_perfection.enabled)" );
  def -> add_action( "use_item,name=azsharas_font_of_power,if=(essence.vision_of_perfection.major&talent.summon_gargoyle.enabled)|(essence.vision_of_perfection.major&cooldown.apocalypse.remains<14&!talent.summon_gargoyle.enabled)" );
  ...
  def -> add_action( "use_item,name=ashvanes_razor_coral,if=(cooldown.apocalypse.remains<gcd&!essence.condensed_lifeforce.major&!essence.vision_of_perfection.major)|(buff.unholy_frenzy.up&!essence.condensed_lifeforce.major&!essence.vision_of_perfection.major)" );
  def -> add_action( "use_item,name=ashvanes_razor_coral,if=(cooldown.apocalypse.remains<gcd&essence.vision_of_perfection.major)|(target.1.time_to_die<cooldown.apocalypse.remains+20&essence.vision_of_perfection.major)" );
