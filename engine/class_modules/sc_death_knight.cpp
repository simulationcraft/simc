...
void death_knight_t::default_apl_frost()
{
  ...
  cooldowns -> add_action( this, "Empower Rune Weapon", "if=(buff.breath_of_sindragosa.up|target.1.time_to_die<20)&talent.breath_of_sindragosa.enabled&runic_power.deficit>60" );
...
void death_knight_t::default_apl_unholy()
{
  ...
  cooldowns -> add_talent( this, "Unholy Blight", "if=variable.disable_aotd&(cooldown.apocalypse.ready&(debuff.festering_wound.stack>=4|rune>=3)|cooldown.apocalypse.remains" );
  ...
  generic -> add_talent( this, "Clawing Shadows", "if=debuff.festering_wound.up&talent.unholy_blight.enabled&!talent.army_of_the_damned.enabled&(((cooldown.unholy_blight.remains>5|cooldown.apocalypse.remains>40)&(cooldown.apocalypse.remains|cooldown.apocalypse.ready&!dot.unholy_blight.remains))|debuff.festering_wound.stack>4)&variable.disable_aotd" );
