...
void death_knight_t::default_apl_unholy()
{
  ...
  covenants -> add_action( "abomination_limb,if=variable.st_planning&rune.time_to_4>(3+buff.runic_corruption.remains)&cooldown.apocalypse.remains&!soulbind.lead_by_example" );
  ...
  cooldowns -> add_action( "use_item,name=inscrutable_quantum_device,if=cooldown.unholy_blight.remains&(pet.army_ghoul.active|pet.apoc_ghoul.active&!talent.army_of_the_damned|target.time_to_pct_20<5)" );
  ...
  cooldowns -> add_action( this, "Apocalypse", "if=debuff.festering_wound.stack>=4&active_enemies=1&(!talent.unholy_blight|conduit.convocation_of_the_dead.rank<5|talent.army_of_the_damned|runeforge.deadliest_coil)&(conduit.convocation_of_the_dead.rank<5|!talent.army_of_the_damned|!runeforge.deadliest_coil)" );
  cooldowns -> add_action( this, "Apocalypse", "if=debuff.festering_wound.stack>=4&active_enemies=1&talent.unholy_blight&conduit.convocation_of_the_dead.rank>=5&talent.army_of_the_damned&runeforge.deadliest_coil&dot.unholy_blight.remains" );
  cooldowns -> add_action( this, "Apocalypse", "if=debuff.festering_wound.stack>=4&active_enemies=1&talent.unholy_blight&!talent.army_of_the_damned&dot.unholy_blight.remains" );
