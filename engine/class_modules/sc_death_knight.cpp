...
void death_knight_t::default_apl_frost()
{
  ...
  cooldowns -> add_talent( this, "Frostwyrm's Fury", "actions.cooldowns+=/frostwyrms_fury,if=(buff.pillar_of_frost.up&(buff.pillar_of_frost.remains<=gcd&azerite.icy_citadel.rank<=1|buff.unholy_strength.remains<=gcd&buff.unholy_strength.up))|buff.icy_citadel.up&(buff.unholy_strength.up|buff.icy_citadel.remains<=gcd)" );
