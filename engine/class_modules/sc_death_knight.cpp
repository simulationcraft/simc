...
void death_knight_t::default_apl_unholy()
{
  ...
  def -> add_action( "use_item,name=azsharas_font_of_power,if=(cooldown.apocalypse.remains<15&essence.condensed_lifeforce.enabled&equipped.ashvanes_razor_coral)|(target.1.time_to_die<cooldown.condensed_lifeforce.remains+30)|(!essence.condensed_lifeforce.enabled&!essence.vision_of_perfection.enabled)|(essence.vision_of_perfection.enabled&cooldown.apocalypse.remains<14&!talent.summon_gargoyle.enabled)|(essence.vision_of_perfection.enabled&talent.summon_gargoyle.enabled)" );
  def -> add_action( "use_item,name=ashvanes_razor_coral,if=debuff.razor_coral_debuff.stack<1" );
  def -> add_action( "use_item,name=ashvanes_razor_coral,if=(pet.guardian_of_azeroth.active&pet.apoc_ghoul.active)|(cooldown.apocalypse.remains<gcd&!essence.condensed_lifeforce.enabled&!talent.army_of_the_damned.enabled&!talent.unholy_frenzy.enabled)|(cooldown.apocalypse.remains<gcd&target.1.time_to_die<cooldown.condensed_lifeforce.remains+20)|(target.1.time_to_die<cooldown.apocalypse.remains+20&essence.condensed_lifeforce.enabled)|(target.1.time_to_die<cooldown.apocalypse.remains+20&essence.vision_of_perfection.enabled)|(buff.unholy_frenzy.up&!essence.condensed_lifeforce.enabled&!essence.vision_of_perfection.enabled)" );
