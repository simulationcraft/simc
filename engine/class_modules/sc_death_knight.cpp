  ...
  else
  {
    ...
    for ( size_t i = 0; i < num_items; i++ )
    {
      ...
      else if ( items[i].name_str == "blast_furnace_door" )
      {
        ...
        def -> add_action( this, "Dancing Rune Weapon", "if=target.time_to_die<90&buff.blast_furnace.up" );
        def -> add_action( potion_str + ",if=buff.blast_furnace.up&dot.soul_reaper.ticking&target.time_to_die<120" );
      }
    ...
    cdbos -> add_talent( this, "Blood Tap", "if=buff.blood_charge.stack>=10" );
    cdbos -> add_action( this, "Death Coil", "if=runic_power>65" );
    cdbos -> add_action( this, "Plague Strike", "if=!dot.blood_plague.ticking&unholy=2" );
    cdbos -> add_action( this, "Icy Touch", "if=!dot.frost_fever.ticking&frost=2" );
    cdbos -> add_action( this, "Death Strike", "if=unholy=2|frost=2|blood=2&blood.death>=1" );
    cdbos -> add_action( this, "Blood Boil", "if=blood=2&blood.death<2" );
    cdbos -> add_action( this, "Outbreak", "if=!dot.blood_plague.ticking" );
    cdbos -> add_action( this, "Plague Strike", "if=!dot.blood_plague.ticking" );
    cdbos -> add_action( this, "Icy Touch", "if=!dot.frost_fever.ticking" );
    ...
    cdbos -> add_talent( this, "Blood Tap" );
...
struct death_knight_module_t : public module_t
{
  ...
  {
    hotfix::register_effect( "Death Knight", "2015-06-29", "Reaper's Harvest had its chance to trigger reduced by "
                                           "6% for Unholy Death Knights.", 268168, hotfix::HOTFIX_FLAG_LIVE )
      .field( "average" )
      .operation( hotfix::HOTFIX_MUL )
      .modifier( 0.94 )
      .verification_value( 0.118555 );

    hotfix::register_effect( "Death Knight", "2015-06-30", "Reaper's Harvest chance to trigger reduced by 60% for "
                                           "Unholy Death Knights.", 268168, hotfix::HOTFIX_FLAG_LIVE )
      .field( "average" )
      .operation( hotfix::HOTFIX_MUL )
      .modifier( 0.4 )
      .verification_value( 0.118555 * 0.94 );

    hotfix::register_effect( "Death Knight", "2015-06-26", "Frost Strike and Obliterate have been reduced to their "
                                           "pre-6.2 damage levels.", 41259, hotfix::HOTFIX_FLAG_LIVE )
      .field( "base_value" )
      .operation( hotfix::HOTFIX_DIV )
      .modifier( 1.2 )
      .verification_value( 96 );

    hotfix::register_effect( "Death Knight", "2015-06-26-1", "Frost Strike and Obliterate have been reduced to their "
                                             "pre-6.2 damage levels.", 60369, hotfix::HOTFIX_FLAG_LIVE )
      .field( "base_value" )
      .operation( hotfix::HOTFIX_DIV )
      .modifier( 1.2 )
      .verification_value( 96 );

    hotfix::register_effect( "Death Knight", "2015-06-26", "Howling Blast damage has been reduced by 13.5%", 41296,
    ...
    hotfix::register_effect( "Death Knight", "2015-06-26-2", "Frost Strike and Obliterate have been reduced to their "
                                             "pre-6.2 damage levels.", 41121, hotfix::HOTFIX_FLAG_LIVE )
      .field( "base_value" )
      .operation( hotfix::HOTFIX_DIV )
      .modifier( 1.2 )
      .verification_value( 258 );

    hotfix::register_effect( "Death Knight", "2015-06-26-3", "Frost Strike and Obliterate have been reduced to their "
                                             "pre-6.2 damage levels.", 60373, hotfix::HOTFIX_FLAG_LIVE )
      .field( "base_value" )
      .operation( hotfix::HOTFIX_DIV )
      .modifier( 1.2 )
      .verification_value( 258 );

    hotfix::register_effect( "Death Knight", "2015-06-23", "Tier-18 2-piece set bonus for Frost Death Knights now "
                             "provides a 3% (down from 5%) gain to haste on critical hits with Obliterate.", 274072,
                             hotfix::HOTFIX_FLAG_LIVE )
      .field( "base_value" )
    ...
    hotfix::register_effect( "Death Knight", "2015-06-23", "Tier-18 2-piece set bonus for Frost Death Knights now "
                             "provides a 6% (down from 10%) gain to critical damage on critical hits with Frost Strike.",
                             274073, hotfix::HOTFIX_FLAG_LIVE )
      .field( "base_value" )
      .operation( hotfix::HOTFIX_SET )
      .modifier( 6 )
