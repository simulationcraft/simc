...
public:
  ...
  struct buffs_t {
    ...
    buff_t* empower_rune_weapon_haste;
...
void death_knight_t::default_apl_blood()
{
  ...
  standard -> add_talent( this, "Blooddrinker", "if=!buff.dancing_rune_weapon.up&runic_power.deficit>=10" );
  standard -> add_action( this, "Death Strike", "talent.blooddrinker.enabled&action.blooddrinker.cooldown<=gcd.remains&!buff.dancing_rune_weapon.up&runic_power.deficit<10")
  ...
  standard -> add_action( this, "Marrowrend", "buff.bone_shield.stack<5&talent.ossuary.enabled&runic_power.deficit>=20" );
  standard -> add_action( this, "Death Strike", "rune.time_to_2<gcd&buff.bone_shield.stack<5&talent.ossuary.enabled&runic_power.deficit<20")
  standard -> add_talent( this, "Bonestorm", "if=runic_power>=100&!buff.dancing_rune_weapon.up" );
  standard -> add_action( this, "Death and Decay", "spell_targets.death_and_decay>=3")
...
void death_knight_t::default_apl_frost()
{
  ...
  cooldowns -> add_action( "call_action_list,name=cold_heart,if=(equipped.cold_heart|talent.cold_heart.enabled)&(((buff.cold_heart_item.stack>=10|buff.cold_heart_talent.stack>=10)&debuff.razorice.stack=5)|target.time_to_die<=gcd)" );
  ...
  cold_heart -> add_action( this, "Chains of Ice", "if=(buff.cold_heart_item.stack>5|buff.cold_heart_talent.stack>5)&target.time_to_die<gcd", "Cold heart conditions" );
  ...
  bos_pooling -> add_talent( this, "Frostscythe", "if=buff.killing_machine.up&runic_power.deficit>(15+talent.runic_attenuation.enabled*3)" );
  bos_pooling -> add_action( this, "Obliterate", "if=runic_power.deficit>=(25+talent.runic_attenuation.enabled*3)" );
  ...
  bos_ticking -> add_talent( this, "Frostscythe", "if=buff.killing_machine.up" );
  ...
  obliteration -> add_talent( this, "Frostscythe", "if=(buff.killing_machine.react|(buff.killing_machine.up&(prev_gcd.1.frost_strike|prev_gcd.1.howling_blast|prev_gcd.1.glacial_advance)))&(rune.time_to_4>gcd|spell_targets.frostscythe>=2)" );
  ...
  aoe -> add_action( this, "Remorseless Winter", "if=talent.gathering_storm.enabled" );
...
void death_knight_t::default_apl_unholy()
{
  ...
  cooldowns -> add_talent( this, "Soul Reaper", "target_if=(target.time_to_die<8|rune<=2)&!buff.unholy_frenzy.up" );
...
void death_knight_t::create_buffs()
{
  ...
  buffs.unholy_frenzy = make_buff( this, "unholy_frenzy", talent.unholy_frenzy )
      ...
      ->add_invalidate(CACHE_HASTE);
  buffs.soul_reaper =
      make_buff( this, "soul_reaper", find_spell( 215711 ) )
      -> set_default_value( find_spell( 215711 ) -> effectN( 1 ).percent() )
      ->add_invalidate(CACHE_HASTE);
  ...
  buffs.empower_rune_weapon_haste =
      make_buff( this, "empower_rune_weapon_haste", spec.empower_rune_weapon )
      ->set_default_value( spec.empower_rune_weapon -> effectN( 3 ).percent() )
