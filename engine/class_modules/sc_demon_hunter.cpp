...
void demon_hunter_t::apl_havoc()
{
  ...
  def -> add_action( this, spec.annihilation, "annihilation", "if=!talent.momentum.enabled|buff.momentum.up|fury.deficit<=30+buff.prepared.up*12|buff.metamorphosis.remains<2" );
