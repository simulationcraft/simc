...
void mage_t::apl_fire()
{
  ...
  items_high_priority->add_action( "use_item,name=azsharas_font_of_power,if=variable.time_to_combustion<=5+15*variable.font_double_on_use&variable.time_to_combustion>0&!variable.disable_combustion" );
...
void mage_t::apl_frost()
{
  ...
  switch ( options.rotation )
  {
    ...
    case ROTATION_NO_ICE_LANCE:
      ...
      single->add_action( this, "Ice Lance", "if=variable.il_if_gaming&buff.brain_freeze.react&(buff.fingers_of_frost.react|prev_gcd.1.flurry)&"
