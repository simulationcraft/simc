...
void mage_t::apl_arcane()
{
  ...
  burn  -> add_action( this, "Arcane Barrage", "if=talent.resonance.enabled&((active_enemies=5)|(equipped.mantle_of_the_first_kirin_tor&active_enemies>2)|(equipped.mystic_kilt_of_the_rune_master&active_enemies>3&active_enemies<15))&buff.arcane_charge.stack=buff.arcane_charge.max_stack", "With Resonance enabled, we can Arcane Barrage if we will maximize its effectiveness, i.e., it will hit max targets. With legendary shoulders or pants we can Arcane Barrage at fewer targets." );
