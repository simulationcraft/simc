...
public:
  ...
  struct hero_talents_t
  {
    ...
    // Hellcaller
    player_talent_t wither; // TODO: Darkglare, Death's Embrace, Roaring Blaze, Scalding Flames, Ashen Remains, Channel Demonfire, Flashpoint, Raging Demonfire, Internal Combustion, Soul Fire
