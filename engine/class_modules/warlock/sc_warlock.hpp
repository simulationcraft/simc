...
public:
  ...
  struct legendary_t
  {
    ...
    item_runeforge_t sacrolashs_dark_strike; //TODO: SL Beta - Check if direct damage is increased, and check if slow effect (unimplemented atm) can proc anything important
