...
void warlock_t::create_apl_demonology()
{
  ...
  def->add_action( "variable,name=next_tyrant_cd,op=set,value=cooldown.decimating_bolt.remains-10,if=variable.use_bolt_timings" );
