...
struct player_t : public actor_t
{
  ...
  gcd_type gcd_type; // If the current GCD is hasted, what haste type is used
...
public:
  ...
  virtual void adjust_global_cooldown(enum gcd_type gcd_type );
  virtual void adjust_auto_attack(enum gcd_type gcd_type );
