...
player_t::player_t( sim_t*             s,
  ...
  dps( name_str + "'s damage per second", s -> statistics_level < 1 ), dpse( s -> statistics_level < 2 ),
  dtps( name_str + "'s damage taken per second", s -> statistics_level < 2 ), dmg_taken( s -> statistics_level < 2 ),
  dps_convergence( 0 ),
  // Heal
