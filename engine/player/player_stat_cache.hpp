...
private:
  ...
  mutable double  _attack_power, _total_attack_power;
...
public:
  ...
  double total_attack_power() const;
  ...
  dobule total_attack_power() const      { return _player -> composite_melee_attack_power_by_type( _player -> default_ap_type() ) * _player -> composite_melee_attack_power_multiplier() }
