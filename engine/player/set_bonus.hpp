...
struct set_bonus_t
{
  ...
  // void enable_set_bonus( trait_sub_tree_e spec, set_bonus_type_e set_bonus, set_bonus_e bonus, bool quiet = true );
  ...
  // const spell_data_t* set( trait_sub_tree_e tree, set_bonus_type_e set_bonus, set_bonus_e bonus ) const;
  ...
  // bool has_set_bonus( trait_sub_tree_e tree, set_bonus_type_e set_bonus, set_bonus_e bonus ) const;
