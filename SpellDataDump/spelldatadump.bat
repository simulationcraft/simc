...
simc64 spell_query="spell.class=paladin">spelldatadump/paladin.txt
simc64 spell_query="spell.class=rogue">spelldatadump/rogue.txt
simc64 spell_query="spell.class=shaman">spelldatadump/shaman.txt
simc64 spell_query="spell.class=mage">spelldatadump/mage.txt
simc64 spell_query="spell.class=warlock">spelldatadump/warlock.txt
