...
$destfile = "E:\simulationcraft\simc-602-alpha-win32-"+$date+"-"+$git+".zip"
...
AAaABhAC0AdwBpAG4AMwAyAC0AIgArACQAZABhAHQAZQANAAoAJABkAGUAcwB0AGYAaQBsAGUAIAA9ACAAIgBFADoAXABzAGkAbQB1AGwAYQB0^
AGkAbwBuAGMAcgBhAGYAdABcAHMAaQBtAGMALQA2ADAAMgAtAGEAbABwAGgAYQAtAHcAaQBuADMAMgAtACIAKwAkAGQAYQB0AGUAKwAiAC0AIg^
