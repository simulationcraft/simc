			     ...
			     const std::string& value )
{
  option_t options[] =
  {
    ...
    { "gear_spell_power_enchant",             OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_MAX    ] ) },
    { "gear_spell_power_arcane_enchant",      OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_ARCANE ] ) },
    { "gear_spell_power_fire_enchant",        OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_FIRE   ] ) },
    { "gear_spell_power_frost_enchant",       OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_FROST  ] ) },
    { "gear_spell_power_holy_enchant",        OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_HOLY   ] ) },
    { "gear_spell_power_nature_enchant",      OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_NATURE ] ) },
    { "gear_spell_power_shadow_enchant",      OPT_INT16,  &( gear.spell_power_enchant[ SCHOOL_SHADOW ] ) },
