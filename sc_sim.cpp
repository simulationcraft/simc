                          ...
                          const std::string& value )
{
  option_t options[] =
  {
    ...
    { "default_health",                   OPT_INT,    &( gear_default.resource[ RESOURCE_HEALTH ] ) },
    { "default_mana",                     OPT_INT,    &( gear_default.resource[ RESOURCE_MANA   ] ) },
    { "default_rage",                     OPT_INT,    &( gear_default.resource[ RESOURCE_RAGE   ] ) },
    { "default_energy",                   OPT_INT,    &( gear_default.resource[ RESOURCE_ENERGY ] ) },
    { "default_focus",                    OPT_INT,    &( gear_default.resource[ RESOURCE_FOCUS  ] ) },
    { "default_runic",                    OPT_INT,    &( gear_default.resource[ RESOURCE_RUNIC  ] ) },
    { "default_armor",                    OPT_INT,    &( gear_default.armor                       ) },
    ...
    { "delta_health",                     OPT_INT,    &( gear_delta.resource[ RESOURCE_HEALTH ]   ) },
    { "delta_mana",                       OPT_INT,    &( gear_delta.resource[ RESOURCE_MANA   ]   ) },
    { "delta_rage",                       OPT_INT,    &( gear_delta.resource[ RESOURCE_RAGE   ]   ) },
    { "delta_energy",                     OPT_INT,    &( gear_delta.resource[ RESOURCE_ENERGY ]   ) },
    { "delta_focus",                      OPT_INT,    &( gear_delta.resource[ RESOURCE_FOCUS  ]   ) },
    { "delta_runic",                      OPT_INT,    &( gear_delta.resource[ RESOURCE_RUNIC  ]   ) },
    { "delta_armor",                      OPT_INT,    &( gear_delta.armor                         ) },
    // Regen
